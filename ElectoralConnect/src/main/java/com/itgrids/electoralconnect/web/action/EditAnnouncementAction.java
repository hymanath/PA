...
public class EditAnnouncementAction extends ActionSupport implements ServletRequestAware,ServletContextAware{

	private static final Logger LOG = Logger.getLogger(EditAnnouncementAction.class);
	private String task;
	...
	public String execute()
	{
		...
		announcementVO.setFileId(fileId);
	...
	public String openEditAnnouncementForm()
	{
		return Action.SUCCESS;
	}
}
