package com.itgrids.electoralconnect.util;

public interface IWebConstants {

	public static final String USER = "USER";
	public static final long FILE_MAX_LENGTH = 2097152;
	public static final int FILE_RANDOM_NO = 1000000000;
	
	public static final String UPLOADED_FILES = "uploaded_files";
	public static final String PARTY_PROFILE = "party_profile";
	...
	public static final String CHART_URL_IN_SERVER = "";
	public static final String STATIC_CONTENT_FOLDER_URL = "";
}
