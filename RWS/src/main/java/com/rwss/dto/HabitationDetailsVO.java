...
public class HabitationDetailsVO {
	...
	private BigDecimal lpcd;
	
	private Long toatlPorpualtionCovered;
	...
	public BigDecimal getLpcd() {
		return lpcd;
	}
	public void setLpcd(BigDecimal lpcd) {
		this.lpcd = lpcd;
	}
	
	public Long getToatlPorpualtionCovered() {
		return toatlPorpualtionCovered;
	}
	public void setToatlPorpualtionCovered(Long toatlPorpualtionCovered) {
