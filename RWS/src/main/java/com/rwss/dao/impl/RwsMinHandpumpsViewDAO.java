...
@Repository
public class RwsMinHandpumpsViewDAO extends GenericDaoHibernate<RwsMinHandpumpsView, String> implements IRwsMinHandpumpsViewDAO {

	@Autowired
	SessionFactory sessionFactory;
	
	public RwsMinHandpumpsViewDAO() {
		super(RwsMinHandpumpsView.class);
	...
	public Long getWaterSourceDeatils(InputVO inputVo,String type) {
		...
		sbm.append("from RwsMinHandpumpsView model,RwsMinAssetNabInkView model2,"
	...
	public List<Object[]> getWaterSourceDeatilsGroupByLocation(InputVO inputVo) {
		...
		queryStr.append(" select distinct"
					  ...
					  + " model.hpCode, "
					  + " model.assetCode" +
					  	" from RwsMinHandpumpsView model,RwsMinAssetNabInkView model2," +
	...
	public List<Object[]>  getWaterSourceDeatils2(InputVO inputVo,String type) {
		...
		sbe.append("where" +
					" model.assetCode=model2.assetCode and "
					+ " model2.habCode=model3.panchCode and model3.mCode=model4.mCode  "
				+ " and model3.dCode=model4.dCode ");
		if (IConstants.SUPPLY_TYPE_SAFE.equalsIgnoreCase(type)) {
					sb.append(" count(model3.safeLpcd) ");			
					sbe.append(" AND model3.safeLpcd != '0' and model3.safeLpcd is not null ");
