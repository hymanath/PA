...
*/
/*public void testCheckForUserGroupMembers()
{

	List<Long> count = staticUsersDAO.checkForUserGroupMembers(29l);
	System.out.println(count);
}*/
public void testdeleteUserMembers()
{

	Integer no = staticUsersDAO.deleteUserMembers(1l);
