...
public class DummyPartyResultsData {
	...
	static{
		...
		Party dummy4 = new Party(new Long(4), "Communist Party of India (Marxist)", "CPM",null, null, null,null, null,null);
		Party dummy5 = new Party(new Long(5), "Samajwadi Party", "SP",null, null, null,null, null,null);
		Party dummy6 = new Party(new Long(6), "Praja Rajyam Party", "PRP",null, null, null,null, null,null);
		
		Party dummy7 = new Party(new Long(7), "Telangana Rashtra Samithi", "TRP",null, null, null,null, null,null);
		Party dummy8 = new Party(new Long(8), "Telugu Desam", "TDP",null, null, null,null, null,null);
		Party dummy9 = new Party(new Long(9), "Lok Satta Party", "LSP",null, null, null,null, null,null);
		Party dummy10 = new Party(new Long(10), "Independent", "IND",null, null, null,null, null,null);
		

		Party dummy11 = new Party(new Long(11), "Pyramid Party of India", "PPOI",null, null, null,null, null,null);
		Party dummy12 = new Party(new Long(12), "Trilinga Praja Pragati Party", null,null, null, null,null, null,null);
		Party dummy13 = new Party(new Long(13), "Republican Party of India (A)", null,null, null, null,null, null,null);
		Party dummy14 = new Party(new Long(14), "B.C.United Front", null,null, null, null,null, null,null);
		Party dummy15 = new Party(new Long(15), "Rajyadhikara Party", null,null, null, null,null, null,null);
		Party dummy16 = new Party(new Long(16), "Bharatiya Jan Shakti", null,null, null, null,null, null,null);
		Party dummy17 = new Party(new Long(17), "Bharatiya Rashtravadi Paksha", "BRP",null, null, null,null, null,null);
		Party dummy18 = new Party(new Long(18), "NTR Telugu Desam Party (Lakshmi Parvathi)", "NTRTDP(LP)",null, null, null,null, null,null);
