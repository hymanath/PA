...
public class BoothMapperServiceTest extends BaseDaoTestCase{
	...
	public void testSaveBoothLocalElectionBodyMappingInfo(){
		...
		boothMapperService.saveBoothLocalElectionBodyMappingInfo(boothIds,null, 488l, false, 1l);
		setComplete();
	}
	...
	public void testSaveAssemblyLocalBodyMappingInfo(){
		...
		boothMapperService.saveAssemblyLocalBodyMappingInfo(488l, localBodyOrWardIds,null, 232l, "2009", true,1l);
		setComplete();
	}
