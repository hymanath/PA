...
public class PanchayatDAOHibernateTest extends BaseDaoTestCase{
	...
	*/
	...
	/*public void testGetPanchayatNameById()
	{
		...
		mandalIds.add(835l);
		mandalIds.add(836l);
		List<Object[]> values = panchayatDAO.getPanchaytsForConstituencyList(mandalIds);
		for (Object[] parms : values) {
			System.out.println(parms[0] +":"+ parms[1]);
		}
	}*/
	
	/*public void testgetCasteInPanchayat(){
		List<Long> panchayatIds = new ArrayList<Long>();
		panchayatIds.add(5344l);
		List<Object[]> values = panchayatDAO.getCasteInPanchayat(panchayatIds);
		for (Object[] parms : values) {
			System.out.println(parms[0] +":"+ parms[1]+":"+ parms[2]);
		}
	}*/
	...
	/*public void testgetPanchayatDetails()
	{
		...
		ids.add(835l);
		ids.add(836l);
		List<Object[]> values = panchayatDAO.getMandalsAnaPanchayays(ids);
		for (Object[] parms : values) {
	...
	public void testGetPanchayatsAndMandalsForPanchayatIdsList()
	{
		List<Long> panchayatIdsList = new ArrayList<Long>(0);
		panchayatIdsList.add(1l);
		List<Object[]> list = panchayatDAO.getPanchayatsAndMandalsForPanchayatIdsList(panchayatIdsList);
		System.out.println(list.size());
	}
}
