...
public interface INominatedPostLocationDashboardService {
	...
	public List<NominatedPostCandidateDtlsVO> getLevelWiseGoIssuedPostions(List<Long> locationValues,String fromDateStr, String toDateStr,Long locationTypeId,String year,Long boardLvlId,List<Long> statusIds);
}
