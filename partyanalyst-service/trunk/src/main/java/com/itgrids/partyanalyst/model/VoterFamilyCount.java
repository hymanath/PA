...
public class VoterFamilyCount {
	...
	public String toString() {
		return "VoterFamilyCount [constituencyId=" + constituencyId
				+ ", tehsilName=" + tehsilName + ", panchayatName="
				+ panchayatName + ", hamletName=" + hamletName + ", boothNo="
				+ boothNo + ", houseNo=" + houseNo + ", count=" + count
				+ ", elderPersonAge=" + elderPersonAge + ", elderVoterId="
				+ elderVoterId + ", elderVoterIdCardNo=" + elderVoterIdCardNo
				+ ", elderPersonName=" + elderPersonName + ", eldPersomGender="
				+ eldPersomGender + ", caste=" + caste + ", youngerVoterId="
				+ youngerVoterId + ", youngerVoterIdCardNo="
				+ youngerVoterIdCardNo + ", youngerPersonName="
				+ youngerPersonName + ", youngPersomGender="
				+ youngPersomGender + ", youngerPersonAge=" + youngerPersonAge
				+ ", boothId=" + boothId + ", voterInfoCountId="
				+ voterInfoCountId + ", uuid=" + uuid + "]";
	}
