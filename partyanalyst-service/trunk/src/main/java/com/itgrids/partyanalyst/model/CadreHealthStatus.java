...
@Entity
@Table(name = "cadre_health_status")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CadreHealthStatus extends BaseModel implements Serializable{
	...
	@Column(name = "cadre_health_status_id", unique = true, nullable = false)
