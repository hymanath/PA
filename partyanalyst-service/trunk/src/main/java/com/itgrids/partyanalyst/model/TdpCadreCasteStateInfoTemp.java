...
@Entity
@Table(name = "tdp_cadre_caste_state_info_temp")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class TdpCadreCasteStateInfoTemp implements java.io.Serializable {
	
	private Long tdpCadreCasteStateInfoTempId;
	...
	@Column(name = "tdp_cadre_caste_state_info_temp_id", unique = true, nullable = false)
	public Long getTdpCadreCasteStateInfoTempId() {
		return tdpCadreCasteStateInfoTempId;
	}
	public void setTdpCadreCasteStateInfoTempId(Long tdpCadreCasteStateInfoTempId) {
		this.tdpCadreCasteStateInfoTempId = tdpCadreCasteStateInfoTempId;
	}
