...
public interface IPartyMeetingMinuteDAO extends GenericDao<PartyMeetingMinute,Long>{
	...
	public Integer updateMeetingPoint(Long minuteId,String minuteText,Long updatedBy,Date updateTime,Long levelId,Long levelValue,String isActionable,Long statusId,UserAddress userAddressId);	
