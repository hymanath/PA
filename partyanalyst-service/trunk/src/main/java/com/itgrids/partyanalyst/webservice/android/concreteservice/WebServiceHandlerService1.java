...
/*           if(votersBoothsDetails!=null && votersBoothsDetails.size()>0)
    ...
    public TdpCadreVO searchTdpCadreDetailsBySearchCriteria(String constituencyId,String name,String memberShipCardNo, String voterCardNo, String refNo, String mobileNo)
    {
    	...
    	try {
    		Long Id = 0l;
    		if(!constituencyId.equalsIgnoreCase("null") && !constituencyId.isEmpty())
    			Id	= Long.valueOf(constituencyId);
    		returnVO = cadreRegistrationService.searchTdpCadreDetailsBySearchCriteria(Id,name,memberShipCardNo, voterCardNo, refNo, mobileNo);
		} catch (Exception e) {
