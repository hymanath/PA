...
@Entity
@Table(name = "meekosam_issue_field_type")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class MeekosamIssueFieldType extends BaseModel implements Serializable {
	private Long meekosamIssueFieldTypeId;
	private String type;
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name = "meekosam_issue_field_type_id", unique = true, nullable = false)
