...
return query.list();
  ...
  public List<Object[]> get2016TotalCadreCountBasedOnUserType(Long locationScopeId,List<Long> locationValue,Long stateId,Date fromDate,Date toDate,Long userTypeId,Long activityMemberId){
  ...
  public List<Object[]> get2016TotalRenewalCadreCountBasedOnUserType(Long locationScopeId,List<Long> locationValue,Long stateId,Date fromDate,Date toDate,Long userTypeId,Long activityMemberId){
...
public List<Object[]> getDateWiseLocationsRegistrationsDetails(GISVisualizationParameterVO inputVO){
		...
		try {
			...
			if(inputVO.getParentLocationType().equalsIgnoreCase(IConstants.STATE)){
				...
				queryStr.append(" constituency.tehsil.tehsilId , constituency.tehsil.tehsilName  as name  ,'RURAL','','',''," +
						"model.cadre2016,model.cadre2016Percent,model.newCadre,model.newCadrePercent,model.renewalCadre,model.renewalCadrePercent");
