...
@Entity
@Table(name = "event_caste_category_info")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class EventCasteCategoryInfo extends BaseModel implements java.io.Serializable {
	...
	@Column(name = "event_caste_category_info_id", unique = true, nullable = false)
