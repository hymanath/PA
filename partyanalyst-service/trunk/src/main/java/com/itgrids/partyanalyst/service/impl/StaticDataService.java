...
public class StaticDataService implements IStaticDataService {
	...
	public CandidateDetailsVO getMuncipalAndCorporationCandidateDetails(Long stateId,String electionType,
		...
		if(resultsCategory.equalsIgnoreCase(IConstants.ALL_CANDIDATES)){
			...
			successorCandidate = electionAnalyzeService.setWinnerCandidateDetailsIntoVO(winnerCandidateResult,successorCandidateResult,0l,0,electionType);
			allCandidates = electionAnalyzeService.setAllCandidateDetailsIntoVo(winnerCandidateResult,allCandidateResult,1,electionType);
			...
			candidateDetailsVO.setCandidateDetails(allCandidates);
			 ...
			 winnerCandidateResult = getLocalElectionDetails(stateId,electionType,electionYear,winnerCandidateRank,partyId,districtId);
			 successorCandidateResult = getLocalElectionDetails(stateId,electionType,electionYear,successorCandidateRank,partyId,districtId);
			 winnerCandidate = electionAnalyzeService.setWinnerCandidateDetailsIntoVO(winnerCandidateResult,successorCandidateResult,0l,0,electionType);
