...
public interface INominatedPostApplicationDAO extends GenericDao<NominatedPostApplication, Long>{
	...
	public List<Object[]> getPositionDetaislOfEveryApplicationStatus(Long boardLevelId,List<Long> levelValues,List<Long> deptsIds,List<Long> boardIds,String statusType);
