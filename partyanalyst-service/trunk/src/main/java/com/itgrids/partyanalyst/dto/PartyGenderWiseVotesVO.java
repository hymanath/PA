...
public class PartyGenderWiseVotesVO implements Serializable {
	...
	private Long rank;
	private Long votesEarnedInBoothForParty;
	...
	public Long getVotesEarnedInBoothForParty() {
		return votesEarnedInBoothForParty;
	}
	public void setVotesEarnedInBoothForParty(Long votesEarnedInBoothForParty) {
		this.votesEarnedInBoothForParty = votesEarnedInBoothForParty;
	}
