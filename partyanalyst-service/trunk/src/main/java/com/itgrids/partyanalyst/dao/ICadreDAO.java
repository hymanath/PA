...
public interface ICadreDAO extends GenericDao<Cadre, Long>{
	...
	public List<Long> findTotalCadreCountForSms(Long registrationId,String cadreType,String searchCriteria,String SocailStatus,String genderStr,String mobileStr,String cadreNameStr,String memberShipNoStr,String roleStr, String bloodGroupStr,String registerCadreSearchTypeStr,String contactsQuery);
