...
public class StrategicCensusStatusVO implements java.io.Serializable{
	...
	private StrategicCensusStatusVO districtDetails;
	private StrategicCensusStatusVO stateDetails;
	...
	public StrategicCensusStatusVO getDistrictDetails() {
		return districtDetails;
	}
	public void setDistrictDetails(StrategicCensusStatusVO districtDetails) {
		this.districtDetails = districtDetails;
	}
	public StrategicCensusStatusVO getStateDetails() {
		return stateDetails;
	}
	public void setStateDetails(StrategicCensusStatusVO stateDetails) {
