...
public class GroupsDetailsForUserVO {
	private Long userId;
	...
	/*public GroupsDetailsForUserVO(){
		
	}
	public GroupsDetailsForUserVO(Long staticGroupId,String staticGroupName,Long numberOfGroups){
