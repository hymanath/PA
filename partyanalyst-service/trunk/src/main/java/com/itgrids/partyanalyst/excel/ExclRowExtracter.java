...
public class ExclRowExtracter {
	...
	public ExclRowExtracter(Sheet sheet,int rowNo,int noOfColumns){
		...
		if(StringUtils.isNotEmpty(getExcelColumn1()) && StringUtils.isNotEmpty(getExcelColumn4()) && StringUtils.isNotEmpty(getExcelColumn7()) && (StringUtils.isNotEmpty(getExcelColumn9()) && StringUtils.isNumeric(StringUtils.replace(getExcelColumn9(), ",", ""))) && StringUtils.isNotEmpty(getExcelColumn9())){
