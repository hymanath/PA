...
public interface ICandidateSearchService {
	...
	public List<CandidateVO> getCandidatesDetails(String searchText,String sortOption ,String order,Integer startIndex,Integer maxResult,String ConstType,Long StateId);
