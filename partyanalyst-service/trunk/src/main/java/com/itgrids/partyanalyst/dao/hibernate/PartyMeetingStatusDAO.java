 ...
 public List<Object[]> getPartyMeetingCountLocationWiseByUserAccess(Long userAccessLevelId,List<Long> userAccessLevelValues,Long stateId,Date fromDate,Date toDate,List<Long> partyMeetingTypeValues)
   ...
   public List<Object[]> getLocationWiseMeetings(List<Long> locationValues,Long locationTypeId,Date fromDate,Date toDate){
	...
	public List<Object[]> getPartyMeetingConductedCountLevelWise(Long userAccessLevelId,List<Long> userAccessLevelValues,Long stateId,Date fromDate,Date toDate,List<Long> partyMeetingTypeValues){
  	  ...
  	  queryStr.append("select model.partyMeeting.partyMeetingType.partyMeetingLevel.partyMeetingLevelId," +
  	  		         " model.mettingStatus," +
  	  		         " count(distinct model.partyMeeting.partyMeetingId)  " +
  	  		         " from PartyMeetingStatus model " +
  	  		         " where " +
		 ...
		 queryStr.append(" group by model.partyMeeting.partyMeetingType.partyMeetingLevel.partyMeetingLevelId,model.mettingStatus " +
       " order by " +
       " model.partyMeeting.partyMeetingType.partyMeetingLevel.partyMeetingLevelId asc ");
	...
	public List<Object[]> getPartyMeetingConductedCountLevelWise1(Long userAccessLevelId,List<Long> userAccessLevelValues,Long stateId,Date fromDate,Date toDate,String leveltype,List<Long> partyMeetingTypeValues){
 	  ...
 	  queryStr.append(",model.partyMeeting.partyMeetingType.partyMeetingLevel.partyMeetingLevelId," +
 	  		         " model.mettingStatus," +
 	  		         " count(distinct model.partyMeeting.partyMeetingId)  " +
 	  		         " from PartyMeetingStatus model " +
 	  		         " where " +
		 ...
		 if(leveltype != null && leveltype.trim().equalsIgnoreCase("District"))
			 queryStr.append(" group by model.partyMeeting.meetingAddress.district.districtId,model.partyMeeting.partyMeetingType.partyMeetingLevel.partyMeetingLevelId,model.mettingStatus  order by  model.partyMeeting.meetingAddress.district.districtId asc");
		 else if(leveltype != null && leveltype.trim().equalsIgnoreCase("Constituency"))
			 queryStr.append(" group by model.partyMeeting.meetingAddress.constituency.constituencyId,model.partyMeeting.partyMeetingType.partyMeetingLevel.partyMeetingLevelId,model.mettingStatus  order by  model.partyMeeting.meetingAddress.constituency.constituencyId asc");
		 else if(leveltype != null && leveltype.trim().equalsIgnoreCase("Mandal"))
			 queryStr.append(" group by model.partyMeeting.meetingAddress.tehsil.tehsilId,model.partyMeeting.partyMeetingType.partyMeetingLevel.partyMeetingLevelId,model.mettingStatus  order by  model.partyMeeting.meetingAddress.tehsil.tehsilId asc");
		 else if(leveltype != null && leveltype.trim().equalsIgnoreCase("Parliament"))
			 queryStr.append(" group by model.partyMeeting.meetingAddress.parliamentConstituency.constituencyId,model.partyMeeting.partyMeetingType.partyMeetingLevel.partyMeetingLevelId,model.mettingStatus  order by  model.partyMeeting.meetingAddress.parliamentConstituency.constituencyId asc"); 
