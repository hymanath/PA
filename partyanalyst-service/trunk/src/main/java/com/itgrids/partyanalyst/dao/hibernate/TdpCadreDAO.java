...
public List<Long> getCadreSurveyUsersStartedByLocation(List<Long> assignedUsersList,Date date)
{
  ...
  return query.list();
	...
	public Integer saveRuralConstituencyDataType1(String prevDate)
	{
		...
		queryString.append(" insert into card_prining_details (voter_name,voter_id_card_number,panchayat_name,mandal_name,constituency_name,district_name,tdp_cadre_id,member_ship_member,photo_type,ref_number,image,constituency_type,voter_image_path) " );
	...
	{
		StringBuffer queryString = new StringBuffer();
		queryString.append("  insert into card_prining_details (voter_name,voter_id_card_number,muncipality_name,constituency_name,district_name,tdp_cadre_id,member_ship_member,photo_type,ref_number,image,constituency_type,voter_image_path) ");
