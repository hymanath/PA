...
public interface IVillageBoothDataPopulationService {
	...
	public VillageBoothElectionVO readExcelAndInsertDataForPublication(final File fPath, final Long publicationId, final Boolean isValidate,Long electionType);
}
