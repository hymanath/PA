...
//	public List<Long> getAllParticipatedPartyResultsForAParty(List<Long> constituencyIds,String electionType,Long partyId,String electionSubType,Long stateId);
	...
	public List<Object[]> findByConstituencyPartyAndElectionsYears(List<Long> partyIds, List<Long> constituencyId, String electionYear);
	...
	public List findCandidateNamesPartyByConstituenciAndElections(List<Long> constituencyId, String electionYear);
	...
	public List<Object[]> partyWiseMemberOfParliments(List<Long> electionIds,List<Long> electionScopeIds,Long loactionTypeId,Long loctionValue);
	public List<Object[]> partyWiseMemberOfAssemblyCandidateCounts(List<Long> electionIds,
			List<Long> electionScopeId, Long loactionTypeId, Long loctionValue);
