...
@Entity
@Table(name = "tdp_cadre_location_info_temp1")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class TdpCadreLocationInfoTemp1 extends BaseModel implements Serializable{

	
	private static final long serialVersionUID = -5371992108676082301L;
	
	private Long tdpCadreLocationInfoTemp1Id;
	...
	@Column(name = "tdp_cadre_location_info_temp1_id", unique = true, nullable = false)
	public Long getTdpCadreLocationInfoTemp1Id() {
		return tdpCadreLocationInfoTemp1Id;
	}

	public void setTdpCadreLocationInfoTemp1Id(Long tdpCadreLocationInfoTemp1Id) {
		this.tdpCadreLocationInfoTemp1Id = tdpCadreLocationInfoTemp1Id;
	}
