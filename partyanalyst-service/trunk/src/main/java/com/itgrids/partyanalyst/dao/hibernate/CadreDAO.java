...
public class CadreDAO extends GenericDaoHibernate<Cadre, Long> implements ICadreDAO{
	...
	public List<Long> findCadreForSMS(Long userId,String cadreType,String searchCriteria,String SocailStatus,String genderStr,String mobileStr,String cadreNameStr,String memberShipNoStr,String roleStr,String bloodGroupStr, String registerCadreSearchTypeStr, String sortOption,String order,String contactsQuery,Integer startIndex,Integer maxResult)
	{
		...
		if(contactsQuery !=null)
			queryBuffer.append(" "+contactsQuery+" ");
	...
	@SuppressWarnings("unchecked")
	public List<Long> findTotalCadreCountForSms(Long userId,String cadreType,String searchCriteria,String SocailStatus,String genderStr,String mobileStr,String cadreNameStr,String memberShipNoStr,String roleStr, String bloodGroupStr,String registerCadreSearchTypeStr,String contactsQuery)
	{
