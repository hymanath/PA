...
public class CadreDAO extends GenericDaoHibernate<Cadre, Long> implements ICadreDAO{
	...
	public List<Long> findCadreForSMS(Long userId,String cadreType,String searchCriteria,String SocailStatus,String genderStr,String mobileStr,String cadreNameStr,String roleStr,String bloodGroupStr, String sortOption,String order,Integer startIndex,Integer maxResult)
	{
		StringBuffer queryBuffer = new StringBuffer("select model.cadreId ");
		queryBuffer.append("from Cadre model where model.user.userId = "+userId+" "+cadreType+" "+searchCriteria+" "+SocailStatus+" "+genderStr+" "+mobileStr+" "+cadreNameStr+" "+roleStr+" "+bloodGroupStr+" "+" order by "+sortOption+" " +order);
	...
	@SuppressWarnings("unchecked")
	public List<Long> findTotalCadreCountForSms(Long userId,String cadreType,String searchCriteria,String SocailStatus,String genderStr,String mobileStr,String cadreNameStr,String roleStr, String bloodGroupStr)
	{
		StringBuffer queryBuffer = new StringBuffer("select count(model.cadreId) ");
		queryBuffer.append("from Cadre model where model.user.userId = "+userId+" "+cadreType+" "+searchCriteria+" "+SocailStatus+" "+genderStr+" "+mobileStr+" "+cadreNameStr+" "+roleStr +" "+bloodGroupStr+" ");
