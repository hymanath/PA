...
public interface IPartyMeetingDAO extends GenericDao<PartyMeeting,Long>{
	...
	public List<Object[]> getLocationWiseStateMeetings(List<Long> locationValues, Long locationTypeId, Date startDate,Date endDate, Long partyMeetingMainTypeId,String type);
}
