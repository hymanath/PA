...
(function ($) {
    ...
    function fnCreateInput(regex, smart, bIsNumber) {
        ...
        var input = $('<input type="text" class="search_init ' + sCSSClass + ' btn " value="' + label + '" style="background : #BCEFDE;"/>');
        th.html(input);
        if (bIsNumber)
    ...
    function fnCreateSelect(aData) {
        var index = i;
        var r = '<select class="search_init select_filter btn "><option value="" class="search_init">' + label + '</option>', j, iLen = aData.length;
        ...
        select.change(function () {
            //var val = $(this).val();
            if ($(this).val() != "") {
                $(this).removeClass("search_init btn ");
            } else {
                $(this).addClass("search_init btn ");
            }
    ...
    $.fn.columnFilter = function (options) {
        ...
        return this.each(function () {
            ...
            $(sFilterRow + " th", oTable).each(function (index) {
                ...
                label = "Search by "; //"Search by " + $(this).text();
                th = $($(this)[0]);
                if (aoColumn != null) {
