		...
		jObj = new JSONObject(getTask());
		 ...
		 else if(jObj.getString("task").equalsIgnoreCase("getSelectedNewsBetweenDates"))
		 {
			 ...
			 if(regVO.getUserAccessType() != null && regVO.getUserAccessType().equalsIgnoreCase("Admin"))
				 newsType = "";
			 fileVOsList = candidateDetailsService.getNewsBetweenSelectedDates(jObj.getString("fromDate"),jObj.getString("toDate"),jObj.getInt("firstResult"),jObj.getInt("maxResult"),newsType,jObj.getString("level"),jObj.getLong("stateId"));
		 }
