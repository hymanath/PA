...
$('#errStatusDiv').html('');
  	...
  	var jsObj =
		{   
			...
			task:"insertObserverDetails"
		};
	
	var rparam ="task="+YAHOO.lang.JSON.stringify(jsObj);
	var url = "insertObserverDetails.action?"+rparam;					
	callAjax(jsObj,url); 
...
function callAjax(jsObj,url)
{
	...
	success : function( o ) {
		try {												
				...
				if(jsObj.task == "insertObserverDetails")
				{
...
<div id="errStatusDiv" style="height: 30px;"></div>
  ...
  <div>Enter Observer Name :<input type="text"  id="observerName" /></div>
 
 <a class="btn btn-primary" style="margin-left:198px;" onclick="insertObserverDetails();">submit</a>
