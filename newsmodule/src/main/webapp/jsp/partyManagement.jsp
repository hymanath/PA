...
function buildUploadNewsForMultipleUsers()
{
   ...
   var str ='';
	...
	str += '       <td class="selectWidthPadd"><input type="text" id="newsfileTitle" name="fileTitle" size="25" maxlength="1000"></input></td>'; 
	...
	str += '       <td class="selectWidthPadd"><textarea id="newsfileDescription" cols="20" rows="3" name="fileDescription" maxlength="2000"></textarea></td>';
	str += '   </tr>';
	str += '   <tr>';
