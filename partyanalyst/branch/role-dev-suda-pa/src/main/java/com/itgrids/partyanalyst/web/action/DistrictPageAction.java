...
public class DistrictPageAction extends ActionSupport implements ServletRequestAware,ServletContextAware{
	...
	public String getDistrictWiseAllElectionResultsForAllParties(){
		...
		try {
			...
			electionTypeId = jObj.getLong("electionTypeId");
			districtIdL = jObj.getLong("districtId");
			districtNameL = jObj.getString("districtName");
		} catch (Exception e) {
			e.printStackTrace();
		}
		
		
		districtWisePartyResultVO = staticDataService.getElectionResultsForDistrict(electionTypeId,districtIdL);
		...
		String chartName = "allPartiesDistrictWisePerformanceIn"+electionType+"Elections_"+districtIdL+"_"+electionTypeId+".png";
		...
		ChartProducer.createLineChart("All Parties Performance In "+electionType+" Elections Of "+districtNameL
		...
		//For Detailed Chart
        String detailedChartName = "detailedChartForAllPartiesDistrictWisePerformanceIn"+electionType+"Elections_"+districtIdL+"_"+electionTypeId+".png";
        ...
        String detailedChartElectionType = electionType.toUpperCase();
        ...
        ChartProducer.createLineChart("All Parties Performance In "+detailedChartElectionType+" Elections Of "+districtNameL
	...
	public String getElectionScopesOfDistrict(){
		...
		try {
			jObj = new JSONObject(getTask());
			System.out.println(jObj);
			districtID = jObj.getLong("distId");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public String getAllPartiesPositionsInDistrictElection(){
		...
		try {
			...
			System.out.println(jObj);
			districtIdL = jObj.getLong("districtId");
			electionIdL = jObj.getLong("electionId");
			electionTypeYearL = jObj.getString("electionTypeYear");
			districtNameL = jObj.getString("districtName");
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		allPartiesPositionsInElection = staticDataService.getAllPartiesPositionsInDistrictElection(electionIdL, districtIdL);
		
		List<PartyPositionsVO> partyPositions = allPartiesPositionsInElection.getPartiesPositionsInElection();
		String chartName = "allPartiesDistrictWisePositionsInElection_"+districtIdL+"_"+electionIdL+".png";
        String chartPath = context.getRealPath("/")+ "charts\\" + chartName;
		...
		ChartProducer.createLineChart("All Parties Positions In "+electionTypeYearL+" Of "+districtNameL
