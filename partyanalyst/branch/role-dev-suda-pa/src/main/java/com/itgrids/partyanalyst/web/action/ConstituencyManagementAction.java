...
public class ConstituencyManagementAction extends ActionSupport implements ServletRequestAware {
	...
	public String getSubLevelInfluenceAction()
	{
		...
		if(task != null){
			try{
				jObj = new JSONObject(getTask());
				regionId = new Long(jObj.getString("regionId"));
				String regionName = jObj.getString("regionName");
				regionType = jObj.getString("regionType");
				Long regionTitleId = new Long(jObj.getString("regionTitleId"));
				String regionTitle = jObj.getString("regionTitle");
				areaType = jObj.getString("areaType");
			}catch(Exception e){
				e.printStackTrace();
			}
		}
	...
	public String getSubLevelLocalGroupsAction()
	{
		...
		if(task != null){
			try{
				...
				String regionName = jObj.getString("regionName");
				regionType = jObj.getString("regionType");
				regionTitleId = new Long(jObj.getString("regionTitleId"));
				String regionTitle = jObj.getString("regionTitle");
				areaType = jObj.getString("areaType");
			}catch(Exception e){
				e.printStackTrace();
	...
	public String sendSMSToInfluencePeople()
	{
		...
		String infPeopleIds = "";
		String message = "";
		Boolean includeName = null;
		String senderName = "";
		
		if(task != null){
			try{
				jObj = new JSONObject(getTask());
				infPeopleIds = jObj.getString("checkedIdString");
				message = jObj.getString("smsMessage");
				includeName = jObj.getBoolean("includeName");
				String taskType = jObj.getString("task");
				senderName = jObj.getString("senderName");
