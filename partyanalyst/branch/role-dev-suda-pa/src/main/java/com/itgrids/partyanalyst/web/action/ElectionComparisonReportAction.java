...
public class ElectionComparisonReportAction extends ActionSupport implements
	...
	public String getComparedElectionResults(){
		...
		try {
			...
			Boolean hasAlliances = jObj.getBoolean("hasAlliance");
			...
			comparedResultsVO = electionComparisonReportService.getComparedElectionResults(partyId, elecIdOne, elecIdTwo, stateOrDistrictId, hasAlliances);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return Action.SUCCESS;
	...
	public String getConstituencyElectionResults(){
		...
		try {
			...
			constiElecResults  = staticDataService.getCompleteElectionResultsForAConstituency(constituencyId, electionId, partyId);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return Action.SUCCESS;
