...
public class ConstituencyPageAction extends ActionSupport implements
	...
	public String getGhmcResults(){
		...
		}else if(type.equalsIgnoreCase("partyWise")){
			if(allLocalBodyIds!=null && allLocalBodyIds.size()!=0){
	   			greaterInfo = localBodyElectionService.findConstituencywiseGreaterElectionResults(allLocalBodyIds.get(0).getId(),constituencyId,value,0l);
	   		}else{  
	   			greaterInfo = new ConstituencyVO();
	   			greaterInfo.setListOfParties(getSelectOptionData());
	   			greaterInfo.setListOfWards(getSelectOptionData());
	   		}
		}else if(type.equalsIgnoreCase("wardWise")){
			if(allLocalBodyIds!=null && allLocalBodyIds.size()!=0){
	   			greaterInfo = localBodyElectionService.findConstituencywiseGreaterElectionResults(allLocalBodyIds.get(0).getId(),constituencyId,new Long(0l),value);
	   		}else{  
	   			greaterInfo = new ConstituencyVO();
	   			greaterInfo.setListOfParties(getSelectOptionData());
	   			greaterInfo.setListOfWards(getSelectOptionData());
	...
	public String getPartiesPerformanceInDiffElectionsAjax(){
		...
		try {
			jObj=new JSONObject(param);
			System.out.println("jObj = "+jObj);
			constiId = jObj.getLong("constituencyId");
		} catch (Exception e) {
			e.printStackTrace();
		}
...
private CategoryDataset createDatasetForCandTrendz(String partyName,String completeVotesPercent,String maleVotesPercent,String femaleVotesPercent,String maleOrFemaleVotesPercent) {
  ...
  public String getPartyWiseConstituencyZptcOrMptcElectionTrends(){
	...
	public String getCensusDetailsForAConstituency()
	{
	   ...
	   {
		   Long constituencyId      = null;
			Long censusYear          = null;
			Long delimitationYear    = null;
			Long censusSelectedIndex = null;
			String censusText        = "";
			String electionYear      = "";
		   ...
		   try{
				 jObj = new JSONObject(getTask());
				 constituencyId      = jObj.getLong("constituencyId");
				 censusYear          = jObj.getLong("censusYear");
				 delimitationYear    = jObj.getLong("delimitationYear");
				 censusSelectedIndex = jObj.getLong("seletedIndex");
				 censusText        = jObj.getString("seletedText");
				 electionYear      = jObj.getString("electionYear");
				 constituencyType  = jObj.getString("constituencyType");
			} catch (Exception e) {
				e.printStackTrace();
			}	
  ...
  public String getParliamentConstituencyAssemblyWiseResults(){
	  ...
	  try {
			jObj=new JSONObject(param);
			chartHeight = jObj.getInt("chartHeight");
			chartWidth = jObj.getInt("chartWidth"); 
			includeOthers = jObj.getString("others");
		...
		constituencyRevenueVillagesVO = constituencyPageService.getConstituencyElecResults(constituencyId, electionYear,new Boolean(includeOthers));
		...
		if(constituencyRevenueVillagesVO.getElectionType().equalsIgnoreCase(IConstants.ASSEMBLY_ELECTION_TYPE)){
			chartName = "partyPerformanceInAllSubLocations_"+constituencyRevenueVillagesVO.getConstituencyId()+"_"+electionYear+".png";
			chartTitle = "Mandal Wise Election Results For "+constituencyRevenueVillagesVO.getConstituencyName()+" "+constituencyRevenueVillagesVO.getElectionType()+" Constituency"+" In "+electionYear;
			domainAxisName = "Mandals";

			detailedChartName = "detailedPartyPerformanceInAllSubLocations_"+constituencyRevenueVillagesVO.getConstituencyId()+"_"+electionYear+".png";
			detailedChartTitle = "Mandal Wise Election Results For "+constituencyRevenueVillagesVO.getConstituencyName()+" "+constituencyRevenueVillagesVO.getElectionType()+" Constituency"+" In "+electionYear;
			detailedDomainAxisName = "Mandals";
		}else{
			chartName = "partyPerformanceInAllSubLocations_"+constituencyRevenueVillagesVO.getConstituencyId()+"_"+electionYear+".png";
			chartTitle = "Assembly Constituencies Wise Election Results For "+constituencyRevenueVillagesVO.getConstituencyName()+" "+constituencyRevenueVillagesVO.getElectionType()+" Constituency"+" In "+electionYear;
			domainAxisName = "Assembly Constituencies";
			
			detailedChartName = "detailedPartyPerformanceInAllSubLocations_"+constituencyRevenueVillagesVO.getConstituencyId()+"_"+electionYear+".png";
			detailedChartTitle = "Assembly Constituencies Wise Election Results For "+constituencyRevenueVillagesVO.getConstituencyName()+" "+constituencyRevenueVillagesVO.getElectionType()+" Constituency"+" In "+electionYear;
  ...
  public String getAssemblyRelatedParliamentsMandalResults(){
	  ...
	  constituencyRevenueVillagesVO = constituencyPageService.getMandalElectionInfoForAConstituency(constituencyId,electionYear,IConstants.PARLIAMENT_ELECTION_TYPE, false);
	  
	  if(constituencyRevenueVillagesVO != null){
		  chartTitle = "Mandal Wise Election Results For "+constituencyRevenueVillagesVO.getConstituencyName()+" Parliament Constituency In "+electionYear;
		  chartName = "mandalWiseParliamentElectionsResults_"+constituencyRevenueVillagesVO.getConstituencyId()+"_"+electionYear+".png";
		  ...
		  detailedChartTitle = "Mandal Wise Election Results For "+constituencyRevenueVillagesVO.getConstituencyName()+" Parliament Constituency In "+electionYear;
		  detailedChartName = "detailedMandalWiseParliamentElectionsResults_"+constituencyRevenueVillagesVO.getConstituencyId()+"_"+electionYear+".png";
