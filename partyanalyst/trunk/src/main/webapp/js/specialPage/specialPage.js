	...
	if(results.length>0)
	 {
	  ...
	  {
	   count++;
	   str+='<li><img class="imageClass" alt="'+results[0].title+'" src="Thumbs/Medium/'+results[0].path+'" onclick="getCandidatesPhotosInAGallary(\''+results[0].gallaryId+'\')" title="'+results[0].gallaryDescription+'"/><br />';
	  ...
	  {
	  count++;
	  str+='<li><img class="imageClass" alt="'+results[1].title+'" src="Thumbs/Medium/'+results[1].path+'" onclick="getCandidatesPhotosInAGallary(\''+results[1].gallaryId+'\')" title="'+results[1].gallaryDescription+'"/><br />';
	  ...
	  for(var i=3;i<results.length;i++)
	  {
	   ...
	   {
		count++;
		str+='<li><img class="imageClass" alt="'+results[i].title+'" title="'+results[i].gallaryDescription+'" src="Thumbs/Medium/'+results[i].path+'"  onclick="getCandidatesPhotosInAGallary('+results[i].gallaryId+')"/><br />';
