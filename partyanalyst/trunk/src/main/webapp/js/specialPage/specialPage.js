...
function getLocations(id){
  ...
  str +='  </tr>';
  str +='  <tr>';
  str +='	   <td class="tdWidth1" style="width: 88px;">Assembly Constituency :<font class="requiredFont">*</font></td>';
  ...
  str +='  </tr>';
  str +='  <tr>';
  str +='	   <td class="tdWidth" style="width: 88px;">Assembly Constituency :<font class="requiredFont">*</font></td>';
  ...
  str +='  </tr>';
  str +='  <tr>';
  str +='	   <td class="tdWidth" style="width: 88px;">Mandal/ Municipality/ Corp/GMC :<font class="requiredFont">*</font></td>';
