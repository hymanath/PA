...
function buildRegionWiseOverViewData(data,divId)
{
	...
	else
	{
		...
		{				
			str += '<tr>';
			str += '<td width="10px"><img width="7" height="5" src="images/icons/districtPage/listIcon.png"></td>';
...
function buildScopeWiseOverViewData(data,divId)
{
	...
	else
	{
		for(var i=0; i<data.length; i++)
		{
			...
			{
				str += '<tr>';
				str += '<td><img width="7" height="5" src="images/icons/districtPage/listIcon.png"></td>';
