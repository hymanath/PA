...
function allCandidatesForaConstituency()
{
	selectedPartyId=0;
...
function winnersForaConstituency()
{
	var ajaxImgElmt = document.getElementById("ajaxLoadDiv");
	ajaxImgElmt.style.display = "block";
	var jsObj=
...
<div class="detailsHead">
	...
	<table>
		...
		<tr>
			<td style="font-weight:bold;"><input type="radio" name="location" value="candidates" onclick="allCandidatesForaConstituency()" checked="checked"> All Candidates</td>		
			<td style="font-weight:bold;"><input style="font-weight:bold;" type="radio" name="location" value="winners" onclick="winnersForaConstituency()"> Winners</td>
