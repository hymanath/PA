	...
	*/
	...
	{	
		...
		if(results.partyName == "All Parties"){
			...
			countElmt+='<span><a style="color:green;font-weight:bold;font-size:12px;" href="javascript:{}" title="click here to hide and show the table" onclick="hideOrShow(\'required_const_body\')"> Total constituencys present in last '+ results.selectedYearsCount +' election years and won by <b style="font-weight:bold;color:red;">'+ results.partyName +'</b> party in any election </a></span>';
		}
