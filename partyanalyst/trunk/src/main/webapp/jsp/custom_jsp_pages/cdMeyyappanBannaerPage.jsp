...
#meyyappanPoliAspirationDiv ul li
{
	margin-bottom: 8px;
}
#meyyappanPoliAspirationDiv ul li
...
<!--  <div id="bannerDiv" style="margin-left: 8px;">
	...
	<div style="background:#FFF; border: 1px solid #5e5e5e; margin-top: 6px; border-radius: 2px 2px 2px 2px; margin-bottom: 3px; padding: 10px 10px 9px; width: 970px; margin-left: 4px;">
	 <table>
		  <tr>
		     <td>
			   <div id="headingStyle"><span class="fontStyle">About C D Meyyappan</span>
			   </div>
			  </td>
		     <td>
			   <div style="margin-left: 425px;"><span class="fontStyle">Political Career</span>
			   </div>
			 </td>
		   </tr>
	 </table>
	<table>
	   <tr valign="top">
	     <td>
		    <div id="meyyBio-dataDiv" style=" width: 420px;">
			  <ul>
				<li><b>Name :</b> C.D. Meyyappan</li>
				<li><b>Age :</b> 47 Years</li>
				<li><b>Educational Qualification :</b> M.A (Public Administration)</li>
				<li><b>Address :</b> 48, Whites Road, Royapettah, Chennai - 600014</li>
				<li><b>Email :</b> cdmeyyappan@yahoo.co.in</li>
				<li><b>Phone :</b> 044-28555436, 098410-78007 </li>
			  </ul>
			 </div>
		 </td>
	     <td>
		    <div id="politicalCarrerDiv" style="margin-left:8px;">
 ...
 <div id="meyyaForthDiv">
	<span class="fontStyle" style="background:#21B2ED;">His Forte</span>
 ...
 <div id="meyyappanPoliAspirationDiv" style="margin-top: 20px;">
	<span class="fontStyle" style="background:#21B2ED;">His Political Aspiration & Promise</span>
