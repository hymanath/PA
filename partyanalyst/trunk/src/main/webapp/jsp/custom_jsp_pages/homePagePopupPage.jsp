...
.boxdiv{width:380px;float:left;margin:5px;background:#f9f9f9;padding:15px;box-shadow:inset 0px 0px 5px #333;border-radius:5px;
}
...
<p style="margin:1px;"><a href="specialPageAction.action?specialPageId=10">View Presidential Election 2012</a></p>
</div>
