...
<div id="alertMessage_dist_uttarakhand"></div>
<div class="view-results"><a onclick="navigateToDistrictPageFrmSpeclPge('districtList_uttarakhand','alertMessage_dist_uttarakhand')" href="javascript:{}">view results</a></div>
...
<select class="selectBoxWidth" id="constituency_uttarakhand" name="constituency">
...
<div id="alertMessage_cons_uttarakhand"></div>
<div class="view-results"><a onclick="navigateToConstituencyPageFrmSpeclPge('constituency_uttarakhand','alertMessage_cons_uttarakhand')" href="javascript:{}">view results</a></div>
