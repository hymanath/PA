		...
		<div class="slider1">
			<ul>
				 ...
				 <a href="candidateElectionResultsAction.action?
					candidateId=262948" title="Okram Ibobi Singh"><img src="./images/candidates/OKRAM IBOBI SINGH.jpeg" alt="Okram Ibobi Singh"/> <span>Okram Ibobi Singh</span> </a>
				 </li>
				<li style="width:125px;">
				 <a href="candidateElectionResultsAction.action?
					candidateId=262779" title="G Gaikhangam"><img src="./images/candidates/GAIKHANGAM.jpeg" alt="G Gaikhangam"/> <span>G Gaikhangam</span> </a>
				 </li>
				<li style="width:125px;">
				 <a href="candidateElectionResultsAction.action?
					candidateId=262979" title="Rishang Keishing"><img src="./images/candidates/RISHANG KEISHING.jpeg" alt="Rishang Keishing"/> <span>Rishang Keishing </span> </a>
				 </li>

				<li style="width:125px;">
				 <a href="candidateElectionResultsAction.action?
					candidateId=262569" title="Radhabinod Koijam"><img src="./images/candidates/RADHABINOD KOIJAM.jpeg" alt="Radhabinod Koijam"/> <span>Radhabinod Koijam</span> </a>
				 </li>
