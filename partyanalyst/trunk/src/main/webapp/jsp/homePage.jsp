      ...
      <div class="content-sec"> 
        ...
        <div class="latest-nu-sec">
         ...
         <marquee onmouseover="this.stop()" onmouseout="this.start()" scrollDelay="180" >
          <font class="scrollDataStyle" color="blue"><u>News</u> : Now You Can View/Analyse <a href="electionDetailsReportAction.action?electionId=136&stateID=21&stateName=Punjab&electionType=Assembly&electionTypeId=2&year=2007">Punjab</a>, <a href="electionDetailsReportAction.action?electionId=158&stateID=27&stateName=Uttar Pradesh&electionType=Assembly&electionTypeId=2&year=2007">Uttar Pradesh</a>, <a href="electionDetailsReportAction.action?electionId=134&stateID=26&stateName=Uttaranchal&electionType=Assembly&electionTypeId=2&year=2007">Uttaranchal</a>, <a href="electionDetailsReportAction.action?electionId=173&stateID=16&stateName=Manipur&electionType=Assembly&electionTypeId=2&year=2007">Manipur</a>, <a href="electionDetailsReportAction.action?electionId=165&stateID=6&stateName=Goa&electionType=Assembly&electionTypeId=2&year=2007">Goa</a>, <a href="electionDetailsReportAction.action?electionId=126&stateID=7&stateName=Gujarat&electionType=Assembly&electionTypeId=2&year=2007">Gujarat</a> States Previous Election Results to Estimate Current Election Results, <a href="javascript:{}"  onclick="openAssembly2011Window()">Pulivendula Bi Election 2011 Results</a> , <a href="javascript:{}"  onclick="openKadapa2011Window()">Kadapa Bi Election 2011 Results</a> , <a href="javascript:{}"  onclick="openTN2011Window()">Tamil Nadu Assembly Election 2011 Results</a> , <a href="javascript:{}"  onclick="openWB2011Window()">West Bengal Assembly Election 2011 Results</a> , <a href="javascript:{}"  onclick="openKerala2011Window()">Kerala Assembly Election 2011 Results</a> , <a href="javascript:{}"  onclick="openAssam2011Window()">Assam Assembly Election 2011 Results</a> , <a href="javascript:{}"  onclick="openPD2011Window()">Puducherry Assembly Election 2011 Results</a>
		</font>
          </marquee>
