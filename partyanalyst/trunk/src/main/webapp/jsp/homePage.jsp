      ...
      <div class="content-sec"> 
        ...
        <div class="latest-nu-sec">
         ...
         <marquee onmouseover="this.stop()" onmouseout="this.start()" scrollDelay="180" >
		  ...
		  Y S JAGAN MOHAN REDDY's interim bail plea rejected by special CBI court. CBI judge, who granted JANARDHANA REDDY bail in illegal mining case, suspended.Cabinate Approves new Telecom Policy.</a>&nbsp;
