...
public class MockData {
	...
	static{	
		Election election1 = new Election(new Long(3), electionScope, null, null, null, "2004", null,null,null);
		Election election2 = new Election(new Long(4), electionScope, null, null, null, "2009", null,null,null);
...
// setting candidateresults with nominations
	...
	public static ElectionWiseMandalPartyResultListVO getAllElectionsInfoForMandalPage(){
		ElectionWiseMandalPartyResultListVO electionWiseMandalPartyResultListVO = new ElectionWiseMandalPartyResultListVO();
		List<ElectionWiseMandalPartyResultVO> allElectionsInMandal = new ArrayList<ElectionWiseMandalPartyResultVO>();
		ElectionWiseMandalPartyResultVO e1;
		e1 = new ElectionWiseMandalPartyResultVO();
		BoothTypeDetailsVO boothsInfo = new BoothTypeDetailsVO(); 
		Set<PartyGenderWiseVotesVO> partyResults = new HashSet<PartyGenderWiseVotesVO>();
		PartyGenderWiseVotesVO p1, p2, p3;
		p1 = new PartyGenderWiseVotesVO();
		p2 = new PartyGenderWiseVotesVO();
		p3 = new PartyGenderWiseVotesVO();
		
		p1.setCandidateID(100l);
		p1.setCandidateNameWithStatus("Chiru (WON)");
		p1.setFemaleBoothResults(200l);
		p1.setMaleBoothResults(150l);
		p1.setFmBoothResults(300l);
		p1.setTotalVotesEarned(650l);
		p1.setPartyID(12l);
		p1.setPartyName("PRP");
		
		p2.setCandidateID(100l);
		p2.setCandidateNameWithStatus("Chiru1");
		p2.setFemaleBoothResults(200l);
		p2.setMaleBoothResults(150l);
		p2.setFmBoothResults(300l);
		p2.setTotalVotesEarned(650l);
		p2.setPartyID(12l);
		p2.setPartyName("PRP1");
		
		p3.setCandidateID(100l);
		p3.setCandidateNameWithStatus("Chiru2");
		p3.setFemaleBoothResults(200l);
		p3.setMaleBoothResults(150l);
		p3.setFmBoothResults(300l);
		p3.setTotalVotesEarned(650l);
		p3.setPartyID(12l);
		p3.setPartyName("PRP2");
		
		partyResults.add(p1);
		partyResults.add(p2);
		partyResults.add(p3);
		
		Set<BoothTotalVotesVO> maleBooths = new HashSet<BoothTotalVotesVO>();
		Set<BoothTotalVotesVO> femaleBooths = new HashSet<BoothTotalVotesVO>();
		Set<BoothTotalVotesVO> fmBooths = new HashSet<BoothTotalVotesVO>();
		BoothTotalVotesVO b1, b2, b3, b4, b5, b6, b7;
		
		b1 = new BoothTotalVotesVO();
		b2 = new BoothTotalVotesVO();
		b3 = new BoothTotalVotesVO();
		b4 = new BoothTotalVotesVO();
		b5 = new BoothTotalVotesVO();
		b6 = new BoothTotalVotesVO();
		b7 = new BoothTotalVotesVO();
		
		b1.setBoothID(100l);
		b1.setTotalVotes(400l);
		b1.setPartNo(11l);
		b1.setMaleVotes(400l);
		b1.setFemaleVotes(0l);
		b1.setVillagesCovered("Gogulapalli Male1");
		
		b2.setBoothID(101l);
		b2.setTotalVotes(450l);
		b2.setPartNo(12l);
		b2.setMaleVotes(450l);
		b2.setFemaleVotes(0l);
		b2.setVillagesCovered("Gogulapalli Male2");
		
		b3.setBoothID(102l);
		b3.setTotalVotes(500l);
		b3.setPartNo(13l);
		b3.setMaleVotes(500l);
		b3.setFemaleVotes(0l);
		b3.setVillagesCovered("Gogulapalli Male3");
		
		b4.setBoothID(103l);
		b4.setTotalVotes(300l);
		b4.setPartNo(21l);
		b4.setMaleVotes(0l);
		b4.setFemaleVotes(300l);
		b4.setVillagesCovered("Gogulapalli Female1");
		
		b5.setBoothID(104l);
		b5.setTotalVotes(350l);
		b5.setPartNo(22l);
		b5.setMaleVotes(0l);
		b5.setFemaleVotes(350l);
		b5.setVillagesCovered("Gogulapalli Female2");
		
		b6.setBoothID(105l);
		b6.setTotalVotes(400l);
		b6.setPartNo(31l);
		b6.setMaleVotes(150l);
		b6.setFemaleVotes(250l);
		b6.setVillagesCovered("Gogulapalli Both3");
		
		b7.setBoothID(106l);
		b7.setTotalVotes(400l);
		b7.setPartNo(32l);
		b7.setMaleVotes(250l);
		b7.setFemaleVotes(150l);
		b7.setVillagesCovered("Gogulapalli Both3");
		...
		e1.setElectionType("Assembly");
		e1.setElectionYear(2004l);
		e1.setBoothTypeDetailsVO(boothsInfo);
		e1.setPartyVotes(partyResults);
		boothsInfo.setFemaleBoothVotes(femaleBooths);
		boothsInfo.setMaleBoothVotes(maleBooths);
		boothsInfo.setMaleFemailBoothVotes(fmBooths);
		allElectionsInMandal.add(e1);
		
		electionWiseMandalPartyResultListVO.setElectionWiseMandalPartyResultVOList(allElectionsInMandal);
