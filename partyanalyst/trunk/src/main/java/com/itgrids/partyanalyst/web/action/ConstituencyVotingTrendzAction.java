...
implements ServletRequestAware, ServletResponseAware, ServletContextAware{
	...
	public String getConstVotingTrendzChart() throws Exception
	{
        ...
        if(electionResList != null && electionResList.size() > 0){
			  ...
			  ChartProducer.createLineChart(chartTitle, "Election", "Percentages", (DefaultCategoryDataset)chartColorsAndDataSetVO.getDataSet(), chartPath,300,820,new ArrayList<Color>(chartColorsAndDataSetVO.getColorsSet()),true);
