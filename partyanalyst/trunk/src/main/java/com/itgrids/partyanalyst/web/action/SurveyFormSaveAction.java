...
public class SurveyFormSaveAction extends ActionSupport implements ServletRequestAware{
	...
	private static final Logger LOG = Logger.getLogger(SurveyFormSaveAction.class);
