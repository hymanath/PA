...
public class AnnouncementAction extends ActionSupport implements ServletContextAware, ServletRequestAware, Preparable{
	...
	public void prepare() throws Exception {
		...
		log.debug("Entered into preapre method of Announcement Action:");
