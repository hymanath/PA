...
public class VoterModificationReportNewAction extends ActionSupport implements ServletRequestAware{
	...
	JSONObject jObj;
	private static final Logger LOG = Logger.getLogger(VoterModificationReportNewAction.class);
