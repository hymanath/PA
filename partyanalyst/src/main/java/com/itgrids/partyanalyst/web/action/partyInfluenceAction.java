...
public class partyInfluenceAction extends ActionSupport implements ServletContextAware,ServletConfigAware{
    ...
    public static final Logger LOG = Logger.getLogger(partyInfluenceAction.class);
	...
	public String execute(){
		...
		Boolean hasAlliances = Boolean.valueOf(alliances);
		
		if(LOG.isDebugEnabled()){
			LOG.debug(" ElectionType :" + electionType);
			LOG.debug("Impacted Party :" + partyName);
			LOG.debug("New Party :" + newParty);
