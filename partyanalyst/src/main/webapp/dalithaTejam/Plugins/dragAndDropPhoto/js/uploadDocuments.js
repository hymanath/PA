/*swadhin*/
function initializeUploadDocument(id) {
	//alert(candidateId)
	var itemStr = '';
	var itemAppendStr = '';
	...
	$('#'+id).filer({      
    changeInput: '<div class="jFiler-input-dragDrop borderSolid" style="margin:0px;padding:10px;"><a class="jFiler-input-choose-btn blue selectFileCss">Select File</a></div></div>',
    showThumbs: true,
    theme: "dragdropbox",
