	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="row">
					<div class="col-sm-9">
						<h4 class="panel-title m_top5">PARTY MEETINGS</h4>
					</div>
					<div class="col-sm-3">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-sm-4">  
						...
						<select class="form-control" id="meetingLevelId" name="meetingLevelId" >
			   ...
			   <!--
				...
				<div class="form-group pull-right">
					<div class="col-md-4 col-xs-12 col-sm-4">
							...
							<button type="button" class="btn btn-primary" id="applicatioSubmitId">Submit Application</button>
...
<div class="modal fade" id="tdpCadreDetailsModalId" role="dialog" >
  ...
  <button id="statusModalId" data-toggle="modal" data-target="#statusModal" style="display: none;"></button>
  ...
  <button type="button" id="dataSubmitId"class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="display:none;">Open Small Modal</button>
			...
			<form name="editMeetingDetailsSubmitFormName" id="editMeetingDetailsSubmitFormId">
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-sm-4">
							<label for="meetingLevel">Meeting Level:</label>
							<select class="form-control" id="meetingLevelModelId" name="partyMeetingVO.meetingLevelId">
					...
					<option value="36">Telangana</option>
						...
						<div class="row">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="col-sm-9">
										<div id="tabUserDetailsModelDivId"></div>
									</div>
									<div class="col-sm-3">
										<div class='pull-right'>
											<ul><li id="editTabUserModelId" class="btn btn-success">Edit Tab User</li></ul></div>
									</div>
								</div>
							</div>
