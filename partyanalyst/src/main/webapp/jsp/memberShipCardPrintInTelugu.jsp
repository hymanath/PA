  ...
  <body  class="bgc">
	...
	function buildSearchCadreInfo(result)
	{
		...
		if(result != null && result.length>0)
		{
			for(var i in result)
			{
				str+=' <div class="span2 offset3"> <img class="offset1" src="https://'+result[i].imageBase64String+'" style="float: inherit;position: absolute;margin-top: 70px;width: 75px;height: 92px;margin-left: 10px;" onerror="buildDefault();"/></div>';
