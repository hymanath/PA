       ...
       $.ajax({
          ...
          data: {task:"basicInfo"}
    	   ...
    	   var TodayTotalWeb = result[0].apWebCount + result[0].tgWebCount;
    		...
    		<c:if test="${sessionScope.USER.isAdmin == 'true'}">				
			$("#totalApTgRegisCount").html('<div style="cursor:pointer;background-color:#DBF1E4" class="span4 mytooltip text-center" data-html="true" data-placement="top" data-toggle="tooltip" data-original-title="[Tab - '+result[3].apTabCount+'] [Web -'+result[3].apWebCount+'] <br> [PartyOffice -'+result[3].apPartyWebCount+'] [Online - '+result[3].apOnlineCount+']"><strong><span style="margin-left:10px;">ANDHRA PRADESH  </span></strong><br><span >'+result[3].apCount+'</span><span class="text-skyblue"></span></div><div style="cursor:pointer;background-color:#DBF1E4;margin-top:2px;" class="span4 mytooltip text-center" data-html="true" data-placement="top" data-toggle="tooltip" data-original-title="[Tab - '+result[3].tgTabCount+'] [Web -'+result[3].tgWebCount+'] <br> [PartyOffice -'+result[3].tgPartyWebCount+'][Online - '+result[3].tgOnlineCount+']"><strong><span style="margin-left:10px;;margin-top:2px;">TELANGANA </span></strong> <br><span >'+result[3].tgCount+'</span><span class="text-skyblue"> </span></div><div id="ghmcTotalDiv" class="span4"  style="background-color:#DBF1E4"><a style="background-color:#DBF1E4;background-image:none;font-size: 13px;" class="btn btn-block border-radius-0" id="totalId" onclick="getGHMCDetails(\'total\');">Get GHMC Drive Details</a></div>');
			</c:if>
			<c:if test="${sessionScope.USER.isAdmin != 'true'}">	
