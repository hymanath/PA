       ...
       $.ajax({
          ...
          data: {task:"basicInfo"}
    	   ...
    	   if(result == "noAccess" || result.indexOf("TDP Party's Election Analysis &amp; Management Platform") > -1){
			...
			$("#todayRegisCount").html('<h2>'+result[0].totalCount+'</h2><p>Members <br/> Registered <span  style="font-weight:bold;">Today</span></p> <ul class="unstyled">  <li> <p class="label">Web -'+TodayTotalWeb+'</p></li>  <li>  <p class="label">Tab - '+TodayTotalTab+'</p>  </li>   <li> <p class="label">Online - '+TodayTotalOnline+'</p>  </li> </ul></div></td>');
			$("#thisWeekRegisCount").html('<h2>'+result[1].totalCount+'</h2><p>Members <br/>Registered <span style="font-weight:bold;"  class="text-orange">This week</span></p><ul class="unstyled"> <li><p class="label">Web -'+WeekTotalWeb+'</p></li><li><p class="label">Tab - '+WeekTotalTab+'</p></li><li><p class="label">Online - '+WeekTotalOnline+'</p></li></ul></div></td>');
			$("#monthRegisCount").html('<h2>'+result[2].totalCount+'</h2><p>Members <br/>Registered <span style="font-weight:bold;" class="text-skyblue">This Month</span></p><ul class="unstyled"> <li><p class="label">Web -'+MonthTotalWeb+'</p></li><li><p class="label">Tab - '+MonthTotalTab+'</p></li><li><p class="label">Online - '+MonthTotalOnline+'</p></li></ul></div></td>');
			$("#totalRegisCount").html('<h2>'+result[3].totalCount+'</h2><p>Members <br/>In <span style="font-weight:bold;"  class="text-green">Total</span></p><ul class="unstyled"> <li><p class="label">Web -'+TotalWeb+'</p></li><li><p class="label">Tab - '+TotalTab+'</p></li><li><p class="label">Online - '+TotalOnline+'</p></li></ul></div></td>');	
