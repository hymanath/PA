       ...
       $.ajax({
          ...
          data: {task:"basicInfo"}
    	   ...
    	   var TodayTotalWeb = result[0].apWebCount + result[0].tgWebCount;
    		...
    		$("#todayApTgRegisCount").html('<div style="cursor:pointer;background-color:#EAEAEA" class="span6 mytooltip"  data-placement="top" data-toggle="tooltip" data-original-title="[Web -'+result[0].apWebCount+'] [Tab - '+result[0].apTabCount+'][Online - '+result[0].apOnlineCount+']"><strong>AP </strong> <br/><span>'+result[0].apCount+'</span></div><div style="cursor:pointer;background-color:#EAEAEA" class="span6 text-right mytooltip" data-placement="top" data-toggle="tooltip" data-original-title="[Web -'+result[0].tgWebCount+'] [Tab - '+result[0].tgTabCount+'] [Online - '+result[0].tgOnlineCount+']"><strong>TS </strong><br/><span> '+result[0].tgCount+'</div>');				
    		$("#thisWeekApTgRegisCount").html('<div style="cursor:pointer;background-color:#fdedd6" class="span6 mytooltip" data-placement="top" data-toggle="tooltip" data-original-title="[Web -'+result[1].apWebCount+'] [Tab - '+result[1].apTabCount+'][Online - '+result[1].apOnlineCount+']"><strong>AP </strong> <br/><span >'+result[1].apCount+'</span></div><div style="cursor:pointer;background-color:#fdedd6" class="span6 text-right mytooltip" data-placement="top" data-toggle="tooltip" data-original-title="[Web -'+result[1].tgWebCount+'] [Tab - '+result[1].tgTabCount+'][Online - '+result[1].tgOnlineCount+']"><strong>TS </strong><br/> <span >'+result[1].tgCount+'</span></div>');					
    		$("#monthApTgRegisCount").html('<div style="cursor:pointer;background-color:#DBEEF4" class="span6 mytooltip" data-placement="top" data-toggle="tooltip" data-original-title="[Web -'+result[2].apWebCount+'] [Tab - '+result[2].apTabCount+'][Online - '+result[2].apOnlineCount+']"><strong>AP </strong> <br/><span>'+result[2].apCount+'</span></div><div style="cursor:pointer;background-color:#DBEEF4" class="span6 text-right mytooltip" data-placement="top" data-toggle="tooltip" data-original-title="[Web -'+result[2].tgWebCount+'] [Tab - '+result[2].tgTabCount+'][Online - '+result[2].tgOnlineCount+']"><strong>TS </strong><br/> <span >'+result[2].tgCount+'</span></div>');
    		$("#totalApTgRegisCount").html('<div style="cursor:pointer;background-color:#DBF1E4" class="mytooltip"  data-placement="top" data-toggle="tooltip" data-original-title="[Web -'+result[3].apWebCount+'] [Tab - '+result[3].apTabCount+'][Online - '+result[3].apOnlineCount+']"><strong>AP - </strong><span >'+result[3].apCount+'</span><span class="text-skyblue"> (NEW - '+result[4].apCount+')</span></div><div style="cursor:pointer;background-color:#DBF1E4" class="mytooltip"  data-placement="top" data-toggle="tooltip" data-original-title="[Web -'+result[3].tgWebCount+'] [Tab - '+result[3].tgTabCount+'][Online - '+result[3].tgOnlineCount+']"><strong>TS - </strong> <span >'+result[3].tgCount+'</span><span class="text-skyblue"> (NEW - '+result[4].tgCount+')</span></div>');
    		$('.mytooltip').tooltip();					
	   });
   }
