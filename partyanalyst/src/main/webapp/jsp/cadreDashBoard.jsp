       ...
       $.ajax({
          ...
          data: {task:"basicInfo"}
    	   ...
    	   if(result == "noAccess" || result.indexOf("TDP Party's Election Analysis &amp; Management Platform") > -1){
			...
			$("#todayRegisCount").html('<h2>'+result[0].totalCount+'</h2><p>Members <br/> Registered <span  style="font-weight:bold;">Today</span></p> <p class="label">Web -'+TodayTotalWeb+'</p>&nbsp&nbsp<p class="label">Tab - '+TodayTotalTab+'</p>&nbsp&nbsp<p class="label">Online - '+TodayTotalOnline+'</p></div></td>');
			$("#thisWeekRegisCount").html('<h2>'+result[1].totalCount+'</h2><p>Members <br/>Registered <span style="font-weight:bold;"  class="text-orange">This week</span></p><p class="label">Web -'+WeekTotalWeb+'</p>&nbsp&nbsp<p class="label">Tab - '+WeekTotalTab+'</p>&nbsp&nbsp<p class="label">Online - '+WeekTotalOnline+'</p></div></td>');
			$("#monthRegisCount").html('<h2>'+result[2].totalCount+'</h2><p>Members <br/>Registered <span style="font-weight:bold;" class="text-skyblue">This Month</span></p><p class="label">Web -'+MonthTotalWeb+'</p>&nbsp&nbsp<p class="label">Tab - '+MonthTotalTab+'</p>&nbsp&nbsp<p class="label">Online - '+MonthTotalOnline+'</p></div></td>');
			$("#totalRegisCount").html('<h2>'+result[3].totalCount+'</h2><p>Members <br/>In <span style="font-weight:bold;"  class="text-green">Total</span></p><p class="label">Web -'+TotalWeb+'</p>&nbsp&nbsp<p class="label">Tab - '+TotalTab+'</p>&nbsp&nbsp<p class="label">Online - '+TotalOnline+'</p></div></td>');	
