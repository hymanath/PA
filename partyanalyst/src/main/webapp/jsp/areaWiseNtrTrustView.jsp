	...
	<div class="container m_top30">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="block boderBlock">
						<div id="financialNtrTrustBlockDivId"></div>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="m_top10">
			<div class="row">
				<div class="col-sm-12">
					<div class="block boderBlock">
						<div id="locationNtrTrustBlockDivId"></div>
					</div>
				</div>
			</div>
		</section>
...
<script src="coreApi/js/ntrTrustConstituencyPage.js" type="text/javascript"></script>
