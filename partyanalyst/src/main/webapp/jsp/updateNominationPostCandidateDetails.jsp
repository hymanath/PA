...
<!-- file Upload -->
<div class="modal fade" id="fileUploadModalBlock" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" style="width:40%;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 id="myModalLabel">UPLOAD FILE DOCUMNETS <span style="color:blue;" class="addNewCandidateErrorCls"><span></h4>
      </div>
	  <form name="fileUploadForCadre" id="fileUploadForCadre"  method="post" enctype="multipart/form-data">
      <div class="modal-body">
			<div class="row">
...
<script type="text/javascript" src="js/nominatedPosts/updateNominationPostCandidate.js"></script>
<script type="text/javascript" src="js/nominatedPosts/updateNominationPostCandidate1.js"></script>
