...
<div id="alertMessage_const_punjab"></div>

<div class="view-results"><a onclick="navigateToConstituencyPageFrmSpeclPge('selectedConstituencyInSpecialPage','alertMessage_const_punjab')" href="javascript:{}">view constituency</a></div>
</div>
</td>
</tr>
