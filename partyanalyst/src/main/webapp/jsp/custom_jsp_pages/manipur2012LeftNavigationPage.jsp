...
<select class="selectBoxWidth" id="districtList_manipur" name="district">
 ...
 <div id="alertMessage_district_manipur"></div>
	<div class="view-results"><a onclick="navigateToDistrictPageFrmSpeclPge('districtList_manipur','alertMessage_district_manipur')" href="javascript:{}">view results</a></div>
	...
	<select class="selectBoxWidth" id="constituency_manipur" name="constituency">
	...
	<div id="alertMessage_cons_manipur"></div>
	<div class="view-results"><a onclick="navigateToConstituencyPageFrmSpeclPge('constituency_manipur','alertMessage_cons_manipur')" href="javascript:{}">view constituency</a></div>
