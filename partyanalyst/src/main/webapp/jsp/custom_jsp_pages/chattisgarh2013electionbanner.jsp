...
<img src="images/specialPage/Chhattisgarh Banner .jpg" style="align:center;width:975px;">
</div>
...
<h3 class="resulth3">Chattisgarh 2013 Elections Statistics</h3>
<div id="ElectionStats" style="margin-bottom:10px;">
<span> Total Assembly Constituencies - <font color="#05A8E9">90</font></span><br>
<span> SC Constituencies - <font color="#05A8E9">10</font> </span><br>
<span>ST Constituencies - <font color="#05A8E9">29</font></span><br>
<span>General Constituencies - <font color="#05A8E9">-</font></span><br>
</div>
		
<h4 style="background-color: rgb(33, 178, 237); color: rgb(255, 255, 255); border-radius: 3px 3px 3px 3px;padding: 4px; margin-left: 2px;">Schedule for the Chattisgarh Legislative Assembly, 2013	</h4>
...
<th colspan="2">For 90 Assembly Constituency</th>
...
<h3 style="">
Chattisgarh Assembly Election Analysis</h3>
...
<th style="padding-right: 27px;">
<c:if test="${loginStatus == 'out'}"> 
<a href="partyResultsAction.action?selectedPartyShortName=BJP&selectedPartyId=163&selectedElectionTypeName=Assembly&selectedLocationName=Chattisgarh&electionType=2&reportLevel=State&stateSelectName=5&partySelectName=163&alliances=true&__checkbox_alliances=true&submitButton=Submit" class="btn">BJP</a>
</c:if>
<c:if test="${sessionScope.USER == null}"> 
<a href="javascript:{}" onclick="checkUserLoginStatus('loginPopupDiv')" class="btn">
BJP</a>
...
<th style="padding-right: 27px;">
<c:if test="${loginStatus == 'out'}"> 
<a href="partyResultsAction.action?selectedPartyShortName=INC&selectedPartyId=362&selectedElectionTypeName=Assembly&selectedLocationName=Chattisgarh&electionType=2&reportLevel=State&stateSelectName=5&partySelectName=362&alliances=true&__checkbox_alliances=true&submitButton=Submit" class="btn">INC</a>
</c:if>
<c:if test="${sessionScope.USER == null}"> 
<a href="javascript:{}" onclick="checkUserLoginStatus('loginPopupDiv')" class="btn">
INC</a>
...
<th style="padding-right: 27px;">
<c:if test="${loginStatus == 'out'}"> 
<a href="partyResultsAction.action?selectedPartyShortName=CPI&selectedPartyId=265&selectedElectionTypeName=Assembly&selectedLocationName=Chattisgarh&electionType=2&reportLevel=State&stateSelectName=5&partySelectName=265&alliances=true&__checkbox_alliances=true&submitButton=Submit" class="btn">CPI</a>
</c:if>
<c:if test="${sessionScope.USER == null}"> 
<a href="javascript:{}" onclick="checkUserLoginStatus('loginPopupDiv')" class="btn">
CPI</a>
...
<th style="padding-right: 27px;">
<c:if test="${loginStatus == 'out'}">
<a href="partyResultsAction.action?selectedPartyShortName=CPM&selectedPartyId=269&selectedElectionTypeName=Assembly&selectedLocationName=Chattisgarh&electionType=2&reportLevel=State&stateSelectName=5&partySelectName=269&alliances=true&__checkbox_alliances=true&submitButton=Submit" class="btn">CPM</a>
</c:if>
<c:if test="${sessionScope.USER == null}"> 
<a href="javascript:{}" onclick="checkUserLoginStatus('loginPopupDiv')" class="btn">
CPM</a>
...
<span style="clear: both; display: inline-block; width: 100%;">Previous Chattisgarh Assembly Elections Results </span>


<a  href="electionDetailsReportAction.action?electionId=257&stateID=5&stateName=Chattisgarh&electionType=Assembly&electionTypeId=2&year=2008" class="btn btn-primary btn-mini"> <img src="images/icons/diamond.png"> 2008</a>


<a href="electionDetailsReportAction.action?electionId=256
&stateID=5&stateName=Chattisgarh&electionType=Assembly&electionTypeId=2&year=2003" class="btn btn-primary btn-mini"> <img src="images/icons/diamond.png"> 2003</a>


<!--<a  href="electionDetailsReportAction.action?electionId=205&stateID=25&stateName=Chattisgarh&electionType=Assembly&electionTypeId=2&year=1998" class="btn btn-primary btn-mini"> <img src="images/icons/diamond.png"> 1998</a>


<a  href="electionDetailsReportAction.action?electionId=206&stateID=25&stateName=Chattisgarh&electionType=Assembly&electionTypeId=2&year=1993" class="btn btn-primary btn-mini"><img src="images/icons/diamond.png"> 1993</a>


<a href="electionDetailsReportAction.action?electionId=207&stateID=25&stateName=Chattisgarh&electionType=Assembly&electionTypeId=2&year=1988"class="btn btn-primary btn-mini"> <img src="images/icons/diamond.png"> 1988</a>


<a  href="electionDetailsReportAction.action?electionId=208&stateID=25&stateName=Chattisgarh&electionType=Assembly&electionTypeId=2&year=1983"class="btn btn-primary btn-mini"><img src="images/icons/diamond.png"> 1983</a>-->
...
<span>View Chattisgarh Districts And Constituencies Results</span>
<br></br></td></tr>
<tr>
<td >
<div class="selectHeading">
	<span class="selectDivStyle">Chattisgarh Districts</span>
	...
	<option value="	375">	Koriya	</option>
	<option value="	376">	Surguja	</option>
	<option value="	377">	Jashpur	</option>
	<option value="	378">	Raigarh	</option>
	<option value="	379">	Korba	</option>
	<option value="	380">	Janjgir - Champa	</option>
	<option value="	381">	Bilaspoor	</option>
	<option value="	382">	Kawardha 	</option>
	<option value="	383">	Rajnandgaon	</option>
	<option value="	384">	Raipur	</option>
	<option value="	385">	Mahasamund	</option>
	<option value="	386">	Dhamtari	</option>
	<option value="	387">	Kanker	</option>
	<option value="	388">	Bastar	</option>
	<option value="	389">	Dantewada	</option>
...
<td>
<div class="selectHeading">
	<span class="selectDivStyle">Chattisgarh Constituencies </span>
...
<option value="40709">Bharatpur Sonhat</option>
<option value="40710">Manendragarh</option>
<option value="40711">Baikunthpur</option>
<option value="40712">Premnagar</option>
<option value="40713">Bhatgaon</option>
<option value="40714">Pratappur</option>
<option value="40715">Ramanujganj</option>
<option value="40716">Samri</option>
<option value="40717">Lundra</option>
<option value="40718">Ambikapur</option>
<option value="40719">Sitapur</option>
<option value="40720">Jashpur</option>
<option value="40721">Kunkuri</option>
<option value="40722">Pathalgaon</option>
<option value="40723">Lailunga</option>
<option value="	40724">Raigarh</option>
<option value="	40725">Sarangarh</option>
<option value="	40726">Kharsia</option>
<option value="	40727">Dharamjaigarh</option>
<option value="	40728">Rampur</option>
<option value="	40729">Korba</option>
<option value="	40730">Katghora</option>
<option value="	40731">Pali Tanakhar</option>
<option value="	40732">Marwahi</option>
<option value="	40733">Kota</option>
<option value="	40734">Lormi</option>
<option value="	40735">Mungeli</option>
<option value="	40736">Takhatpur</option>
<option value="	40737">Bilha</option>
<option value="	40738">Bilaspur</option>
<option value="	40739">Beltara</option>
<option value="	40740">Masturi</option>
<option value="	40741">Akaltara</option>
<option value="	40742">Janjgir Champa</option>
<option value="	40743">Sakti</option>
<option value="	40744">Chandrapur</option>
<option value="	40745">Jaijaipur</option>
<option value="	40746">Pamgarh</option>
<option value="	40747">Saraipali</option>
<option value="	40748">Basna</option>
<option value="	40749">Khallari</option>
<option value="	40750">Mahasamund</option>
<option value="	40751">Bilaigarh</option>
<option value="	40752">Kasdol</option>
<option value="	40753">Baloda Bazar</option>
<option value="	40754">Bhatapara</option>
<option value="	40755">Dharsiwa</option>
<option value="	40756">Raipur Rural</option>
<option value="	40757">Raipur City West</option>
<option value="	40758">Raipur City North</option>
<option value="	40759">Raipur City South</option>
<option value="	40760">Arang</option>
<option value="	40761">Abhanpur</option>
<option value="	40762">Rajim</option>
<option value="	40763">Bindranawagarh</option>
<option value="	40764">Sihawa</option>
<option value="	40765">Kurud</option>
<option value="	40766">Dhamtari</option>
<option value="	40767">Sanjari Balod</option>
<option value="	40768">Dondi Lohara</option>
<option value="	40769">Gunderdehi</option>
<option value="	40770">Patan</option>
<option value="	40771">Durg Rural</option>
<option value="	40772">Durg City</option>
<option value="	40773">Bhilai Nagar</option>
<option value="	40774">Vaishali Nagar</option>
<option value="	40775">Ahiwara</option>
<option value="	40776">Saja</option>
<option value="	40777">Bemetara</option>
<option value="	40778">Nawagarh</option>
<option value="	40779">Pandariya</option>
<option value="	40780">Kawardha</option>
<option value="	40781">Khairagarh</option>
<option value="	40782">Dongargarh</option>
<option value="	40783">Rajnandgaon</option>
<option value="	40784">Dongargaon</option>
<option value="	40785">Khujji</option>
<option value="	40786">Mohla Manpur</option>
<option value="	40787">Antagarh</option>
<option value="	40788">Bhanupratappur</option>
<option value="	40789">Kanker</option>
<option value="	40790">Keshkal</option>
<option value="	40791">Kondagaon</option>
<option value="	40792">Narayanpur</option>
<option value="	40793">Bastar</option>
<option value="	40794">Jagdalpur</option>
<option value="	40795">Chitrakot</option>
<option value="	40796">Dantewada</option>
<option value="	40797">Bijapur</option>
<option value="	40798">Konta</option>
...
function buildGujaratElectionResult(myResults)
{
	...
	electionResult+='Party Wise Results Of Chattisgarh Vidhan Sabha 2013</h3>';
	electionResult+='</div>';
	...
	chart.draw(data,{width:400, height: 250, title:'Chattisgarh Vidhan Sabha Election 2013 Lead/Won Chart'});
	}
}
