...
<img src="images/specialPage/Mizoram Banner.jpg" style="align:center;width:975px;">
</div>
...
<h3 class="resulth3">Mizoram 2013 Elections Statistics</h3>
<div id="ElectionStats" style="margin-bottom:10px;">
<span> Total Assembly Constituencies - <font color="#05A8E9">40</font></span><br>
<span> SC Constituencies - <font color="#05A8E9">-</font> </span><br>
<span>ST Constituencies - <font color="#05A8E9">39</font></span><br>
<span>General Constituencies - <font color="#05A8E9">-</font></span><br>
</div>
		
<h4 style="background-color: rgb(33, 178, 237); color: rgb(255, 255, 255); border-radius: 3px 3px 3px 3px;padding: 4px; margin-left: 2px;">Schedule for the Mizoram Legislative Assembly, 2013	</h4>
...
<h3 style="">
Mizoram Assembly Election Analysis</h3>
...
<th style="padding-right: 27px;">
<c:if test="${loginStatus == 'out'}"> 
<a href="partyResultsAction.action?selectedPartyShortName=BJP&selectedPartyId=163&selectedElectionTypeName=Assembly&selectedLocationName=Mizoram&electionType=2&reportLevel=State&stateSelectName=18&partySelectName=163&alliances=true&__checkbox_alliances=true&submitButton=Submit" class="btn">BJP</a>
</c:if>
<c:if test="${sessionScope.USER == null}"> 
<a href="javascript:{}" onclick="checkUserLoginStatus('loginPopupDiv')" class="btn">
BJP</a>
...
<th style="padding-right: 27px;">
<c:if test="${loginStatus == 'out'}"> 
<a href="partyResultsAction.action?selectedPartyShortName=INC&selectedPartyId=362&selectedElectionTypeName=Assembly&selectedLocationName=Mizoram&electionType=2&reportLevel=State&stateSelectName=18&partySelectName=362&alliances=true&__checkbox_alliances=true&submitButton=Submit" class="btn">INC</a>
</c:if>
<c:if test="${sessionScope.USER == null}"> 
<a href="javascript:{}" onclick="checkUserLoginStatus('loginPopupDiv')" class="btn">
INC</a>
...
<th style="padding-right: 27px;">
<c:if test="${loginStatus == 'out'}"> 
<a href="partyResultsAction.action?selectedPartyShortName=CPI&selectedPartyId=265&selectedElectionTypeName=Assembly&selectedLocationName=Mizoram&electionType=2&reportLevel=State&stateSelectName=18&partySelectName=265&alliances=true&__checkbox_alliances=true&submitButton=Submit" class="btn">CPI</a>
</c:if>
<c:if test="${sessionScope.USER == null}"> 
<a href="javascript:{}" onclick="checkUserLoginStatus('loginPopupDiv')" class="btn">
CPI</a>
...
<th style="padding-right: 27px;">
<c:if test="${loginStatus == 'out'}">
<a href="partyResultsAction.action?selectedPartyShortName=CPM&selectedPartyId=269&selectedElectionTypeName=Assembly&selectedLocationName=Mizoram&electionType=2&reportLevel=State&stateSelectName=18&partySelectName=269&alliances=true&__checkbox_alliances=true&submitButton=Submit" class="btn">CPM</a>
</c:if>
<c:if test="${sessionScope.USER == null}"> 
<a href="javascript:{}" onclick="checkUserLoginStatus('loginPopupDiv')" class="btn">
CPM</a>
...
<span style="clear: both; display: inline-block; width: 100%;">Previous Mizoram Assembly Elections Results </span>


<a  href="electionDetailsReportAction.action?electionId=255&stateID=18&stateName=Mizoram&electionType=Assembly&electionTypeId=2&year=2008" class="btn btn-primary btn-mini"> <img src="images/icons/diamond.png"> 2008</a>


<a href="electionDetailsReportAction.action?electionId=254&stateID=18&stateName=Mizoram&electionType=Assembly&electionTypeId=2&year=2003" class="btn btn-primary btn-mini"> <img src="images/icons/diamond.png"> 2003</a>


<a  href="electionDetailsReportAction.action?electionId=253&stateID=18&stateName=Mizoram&electionType=Assembly&electionTypeId=2&year=1998" class="btn btn-primary btn-mini"> <img src="images/icons/diamond.png"> 1998</a>


<a  href="electionDetailsReportAction.action?electionId=252&stateID=18&stateName=Mizoram&electionType=Assembly&electionTypeId=2&year=1993" class="btn btn-primary btn-mini"><img src="images/icons/diamond.png"> 1993</a>


<a href="electionDetailsReportAction.action?electionId=251&stateID=18&stateName=Mizoram&electionType=Assembly&electionTypeId=2&year=1988"class="btn btn-primary btn-mini"> <img src="images/icons/diamond.png"> 1989</a>


<a  href="electionDetailsReportAction.action?electionId=250&stateID=18&stateName=Mizoram&electionType=Assembly&electionTypeId=2&year=1983"class="btn btn-primary btn-mini"><img src="images/icons/diamond.png"> 1987</a>
<a  href="electionDetailsReportAction.action?electionId=249&stateID=18&stateName=Mizoram&electionType=Assembly&electionTypeId=2&year=1983"class="btn btn-primary btn-mini"><img src="images/icons/diamond.png"> 1984</a>
...
<span>View Mizoram Districts And Constituencies Results</span>
<br></br></td></tr>
<tr>
<td >
<div class="selectHeading">
	<span class="selectDivStyle">Mizoram Districts</span>
	...
	<option value="0">Select District</option>
		<option value="435">	Aizawl	</option>	
	<option value="	436">	Lunglei	</option>	
	<option value="	437">	Champhai	</option>	
	<option value="	438">	Lawngtlai	</option>	
	<option value="	439">	Mamit	</option>	
	<option value="	440">	Kolasib	</option>	
	<option value="	441">	Serchhip	</option>	
	<option value="	442">	Saiha	</option>	
...
<td>
<div class="selectHeading">
	<span class="selectDivStyle">Mizoram Constituencies </span>
...
<option value="40825	">	Hachhek		</option>
	<option value="40826	">	Dampa		</option>
	<option value="40827	">	Mamit		</option>
	<option value="40828	">	Tuirial		</option>
	<option value="40829	">	Kolasib		</option>
	<option value="40830	">	Serlui		</option>
	<option value="40831	">	Tuivawl		</option>
	<option value="40832	">	Chalfilh		</option>
	<option value="40833	">	Tawi		</option>
	<option value="40834	">	Aizawl North I		</option>
	<option value="40835	">	Aizawl North II		</option>
	<option value="40836	">	Aizawl North III		</option>
	<option value="40837	">	Aizawl East I		</option>
	<option value="40838	">	Aizawl East II		</option>
	<option value="40839	">	Aizawl West I		</option>
	<option value="40840	">	Aizawl West II		</option>
	<option value="40841	">	Aizawl West III		</option>
	<option value="40842	">	Aizawl South I		</option>
	<option value="40843	">	Aizawl South II		</option>
	<option value="40844	">	Aizawl South III		</option>
	<option value="40845	">	Lengteng		</option>
	<option value="40846	">	Tuichang		</option>
	<option value="40847	">	Champhai North		</option>
	<option value="40848	">	Champhai South		</option>
	<option value="40849	">	East Tuipui		</option>
	<option value="40850	">	Serchhip		</option>
	<option value="40851	">	Tuikum		</option>
	<option value="40852	">	Hrangturzo		</option>
	<option value="40853	">	South Tuipui		</option>
	<option value="40854	">	Lunglei North		</option>
	<option value="40855	">	Lunglei East		</option>
	<option value="40856	">	Lunglei West		</option>
	<option value="40857	">	Lunglei South		</option>
	<option value="40858	">	Thorang		</option>
	<option value="40859	">	West Tuipui		</option>
	<option value="40860	">	Tuichawng		</option>
	<option value="40861	">	Lawngtlai West		</option>
	<option value="40862	">	Lawngtlai East		</option>
	<option value="40863	">	Saiha		</option>
	<option value="40864	">	Palak		</option>
...
function buildGujaratElectionResult(myResults)
{
	...
	electionResult+='Party Wise Results Of Mizoram Vidhan Sabha 2013</h3>';
	electionResult+='</div>';
	...
	chart.draw(data,{width:400, height: 250, title:'Mizoram Vidhan Sabha Election 2013 Lead/Won Chart'});
	}
}
