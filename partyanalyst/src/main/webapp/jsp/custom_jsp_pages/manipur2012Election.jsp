...
<br>
 ...
 <object height="220" width="320"><param value="https://www.youtube.com/v/mMTRWXNVXCw?version=3" name="movie"><param value="true" name="allowFullScreen"><param value="always" name="allowscriptaccess"><embed height="220" width="320" allowfullscreen="true" allowscriptaccess="always" type="application/x-shockwave-flash" src="https://www.youtube.com/v/mMTRWXNVXCw?version=3"></object></td>
</tr>
</center>
<!--<tr><td colspan="7"> <br />
<b><span style="-moz-border-radius:3px;padding:3px;margin-top: 15px;background: #d2e888;">Previous Manipur Assembly Elections Results :</span></b><br /><br />
