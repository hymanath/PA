                            	...
                            	<ul class="list-inline">
                                	<li>
                                    	<div class="panel panel-default panelProfile">
                                            <div class="panel-body">
                                            	<img class="img-responsive img-circle" src="Assests/img/thumb.jpg" />
                                                <p>Kollu Ravindra</p>
                                                <p>AP9623650860</p>
                                                <p>+91 9554564654</p>
                                            </div>
                                            <div class="panel-footer">
                                            	<label class="checkbox-inline">
                                                	<input type="checkbox"/>Select Profile
                                                </label>
                                            </div>
                                        </div>
                                    </li>
                    	...
                    	<div class="col-md-12 col-xs-12 col-sm-12">
                        	...
                        	<div class="block">
                            	<div class="row">
                                    ...
                                    <div class="col-md-3 col-xs-12 col-sm-6">
                                    	<label>Own DIstrict</label>
                                        <select>
                                        	<option>22</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 col-xs-12 col-sm-6">
                                    	<label>Incharge DIstrict</label>
                                        <select>
                                        	<option>04</option>
                                        </select>
                                    </div>
