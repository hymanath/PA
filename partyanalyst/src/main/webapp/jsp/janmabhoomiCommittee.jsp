			...
			str+='<div class="col-sm-3">';
				str+='<div class="bordermemberes" style="border:1px solid #0E0E0E;background-color:#DCDCDC">';
					...
					var scType=false;
						...
						var msgTemplate = "Note: Committee Must Contain Minimum ";
							...
							if(result.desinationVOList[i].desinationMebersVOList !=null && result.desinationVOList[i].desinationMebersVOList.length>0){
								...
								str+='<tr>';
									...
									if(result.status != 'Approved' ){
										...
										<c:choose>
										<c:when test="${fn:contains(sessionScope.USER.entitlements,'JANMABHOOM_COMMITTEE_EDIT_USER_ENTITLEMENT' )  && fn:contains(sessionScope.USER.entitlements, 'JANMABHOOM_COMMITTEE_DASHBOARD_USER_ENTITLEMENT' ) && fn:contains(sessionScope.USER.entitlements, 'JANMABHOOM_COMMITTEE_ENTRY_USER_ENTITLEMENT' ) && fn:contains(sessionScope.USER.entitlements, 'JANMABHOOM_COMMITTEE_APPROVE_USER_ENTITLEMENT' ) }">
										if( result.desinationVOList[i].desinationMebersVOList[j].status == "Approved" ){
										str+='<td><h5 style="color:green;text-decoration:underline;" class="memberAddEditDetailsCls" attr_type="edit"  attr_member_id="'+result.desinationVOList[i].desinationMebersVOList[j].id+'" attr_member_name="'+result.desinationVOList[i].desinationMebersVOList[j].memeberName+'" attr_mobile_no="'+result.desinationVOList[i].desinationMebersVOList[j].mobileNumber+'" attr_voterCard_no="'+result.desinationVOList[i].desinationMebersVOList[j].voterId+'" attr_membership_no="'+result.desinationVOList[i].desinationMebersVOList[j].memberShipCardId+'" attr_committee_id="'+committeId+'" attr_reject_user_image="'+result.desinationVOList[i].desinationMebersVOList[j].imageUrl+'">Reject</h5></td>';
			...
			if(bcType === true && scType === true && stType === true && approvedBooleanaVal === true){
				if(result.status != 'Approved'){
					...
					str+='<div class="col-sm-12 m_top20">';
						str+='<div class="row">';
						<c:choose>
							<c:when test="${fn:contains(sessionScope.USER.entitlements, 'JANMABHOOM_COMMITTEE_DASHBOARD_USER_ENTITLEMENT' ) && fn:contains(sessionScope.USER.entitlements, 'JANMABHOOM_COMMITTEE_APPROVE_USER_ENTITLEMENT' ) && fn:contains(sessionScope.USER.entitlements,'JANMABHOOM_COMMITTEE_EDIT_USER_ENTITLEMENT' ) && fn:contains(sessionScope.USER.entitlements, 'JANMABHOOM_COMMITTEE_ENTRY_USER_ENTITLEMENT' )}">
