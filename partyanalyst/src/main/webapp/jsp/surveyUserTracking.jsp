...
<script src="js/maps/apLocation.js"></script>
...
function getVoterDetails()
{
	...
	$.ajax({
     type: "POST",
     url: "getVotersLocationDetails.action",
...
function buildLocationDetails(result)
{
	...
	$.each(result,function(index,value){
		...
		var mandalOrMuncipalityName = '';

		if(value.tehsilName != null)
			mandalOrMuncipalityName = value.tehsilName;
		else if(value.muncipalityName != null)
			mandalOrMuncipalityName = value.muncipalityName;


	var voterDetails = 
		{ "type": "Feature",
		"properties": {"name":value.voterName,"mobileNo":value.mobileNumber,"ac_name":value.constituency,"tehsil_name":mandalOrMuncipalityName},
