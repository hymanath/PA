  ...
  <div class="container m-top15">
        <div class="row">
	       <div class="span12">
		      ...
		      <img src="images/About-Us_Headder-1.gif">
		   </div>
		</div>
			...
			<div class="widget3   p-m-bottom0px">
				...
				<div class="row">
					...
					<div class=" widget green span4  whitegloss ">
								...
								<h5><small style="margin-left: 206px;font-size: 15px;"><b>Get in touch with our support team to get more information about Public/Politician</b></small></h5>
									<a href="electionAnalysisAndManagementTool.action" class="btn btn btn-primary pull-right" type="button" style="margin-top: -31px; margin-right:17px;">View Now</a>
			</div>
	 ...
	 <h3 class="font2"style="margin-top: 4px;" >Party Analyst's Exclusive Services For Politicians / Parties and Media<small class="pull-right" style="margin-top: 16px; margin-right: 14px;">-We always strive to make things easy for you</small></h3>
			<div class="row ">
				...
				<div class="span3">
					...
					<img src="images/voters_pluse_New.gif" style="  border:1px solid #ccc;">
					</a>
				</div>
				<div class="span3">
				    <a  title="Reports" href="constituencyProfileReport.action">
					<img src="images/Constituency_A.gif" style=" border:1px solid #ccc;">
					</a>
				</div>
				<div class="span3">
				    <a title="Our unique tool designed for Politicians" href="electionAnalysisAndManagementTool.action">
					<img src="images/Election-Analysis-and-Management-Tool_A_1.gif" style="border:1px solid #ccc;">
					</a>
				</div>
				<div class="span3">
				    <a title="News tracking service" href="newsMonitoringService.action">
					<img src="images/News-Monitoring-dervices.gif" style="border:1px solid #ccc;">
					</a>
				</div>
			</div>
		</div>
 ...
 <div class="row">
				<div class="span12">
						...
						<div class="span5 pull-right breadcrumb"style="border: 1px solid #CCCCCC; background:#fff;">
								...
								<!--<a href="javascript:{}" onClick="showFeedBackFormPanel()"> <button class="btn btn-primary pull-right" type="button" style="margin-top: -55px;">Are you ready to<br> Contribute Now >></button></a>-->
