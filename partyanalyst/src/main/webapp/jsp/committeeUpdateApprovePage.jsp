			...
			str+='<table class="table table-condensed" style="background-color:rgba(0,0,0,0.1);">';
				  ...
				  for(var i in result){
				   ...
				   str+='<td rowspan="'+result[i].locationsList.length+'" style="text-align: center;padding-top:'+paddingTop+'px;">'+result[i].committeeName+'</td>';
					...
					{					
						 str+='<td ><img data-attr-tdpCommitteememberId="'+result[i].locationsList[j].tdpCommitteeMemberId+'" style="margin-top: 26px; margin-left: 12px;" width="35"  height="35" src="images/cadre_images/'+result[i].locationsList[j].positionId+'" onerror="setDefaultImage(this);"/></td>';
