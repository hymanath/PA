...
<html lang="en">
  ...
  <body>
	...
	<div class="container-fluid">
		...
		<div class="row m_top20">
				<div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
					<div class="row">
						...
						<div class="col-md-4 col-sm-4 col-xs-4 form-group">
							<input type="text" id="disabledInput" class="form-control  editClass"  value="${cadreCommitteeVO.gender}" placeholder="Gender: Male" name="cadreRegistrationVO.gender" disabled>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4 col-md-offset-2  col-sm-6 col-xs-6 form-group">
					<input type="text" id="disabledInput" class="form-control editClass"  value="${cadreCommitteeVO.mobileNo}" placeholder="Mobile No:9632587410" name="cadreRegistrationVO.mobileNumber" disabled>
				</div>
		...
		<div class="row m_top20">
			...
			<div class="hiddenDivCls" style="display:none;">
				<input type="hidden" value="1" name="cadreRegistrationVO.previousRollesList[${indexValue.index}].cadreCommitteeLevelId"/>				
				<input type="hidden" value="3" name="cadreRegistrationVO.previousRollesList[${indexValue.index}].cadreCommitteeId"/>				
				<input type="hidden" value="17" name="cadreRegistrationVO.previousRollesList[${indexValue.index}].cadreRoleId"/>				
		...
		<div class="row m_top20">
			...
			<div class="hiddenDivCls" style="display:none;">
				<input type="hidden" value="${electionVO.electionTypeId}" name="cadreRegistrationVO.previousParicaptedElectionsList[${indexValue.index}].electionTypeId"/>				
				<input type="hidden" value="3" name="cadreRegistrationVO.previousParicaptedElectionsList[${indexValue.index}].constituencyId"/>				
	...
	function addMoreRoles()
		...
		var str='';
		str+='<div class="row" id="roleDiv'+rolesCount+'">';
