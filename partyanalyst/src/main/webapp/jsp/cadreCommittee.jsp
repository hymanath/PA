...
<html lang="en">
  <head>
	...
	<style>
	#publicrepresantative,#mandalaffiliated
	{
		display:none;
	}
	</style>
  ...
  <body>
	<div class="container-fluid">
		...
		<input type="hidden" value="1" id="searchTypeId"/>
		<div class="row" id="basicCommitteeDiv">
		<div class="row m_top20">
			<div class="col-md-4 col-md-offset-2  col-sm-6 col-xs-6 ">
				<div class="radio pull-right">
				  <label>
				    <input type="radio" name="committeeType" onclick="validateSearchType('1')"> Village / Ward / Division
				  </label>
			    </div>
			</div>
