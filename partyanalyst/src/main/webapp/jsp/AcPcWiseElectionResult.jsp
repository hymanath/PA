...
$(".regionhighLight").live( "click", function() {

	$(".regionhighLight").removeClass("active");
...
function buildPieChart(donut,colorsarr)
{
...
function buildColumnChart(graph3d,colorsarrForColumn)
{
	Highcharts.setOptions({
