...
<div id="suggestiveMainDiv" align="center">
 ...
 <table style="width:58%;">
           <tr> <td>Constituency <font id="requiredValue" class="requiredFont">*</font> </td>
			...
			<td> Year <font id="requiredValue" class="requiredFont">*</font> </td>
			<td></td><td><select id="year">
			<option value="2009"> 2009 </option>
			</select></td>
		</tr>
			<tr><td>type</td><td></td><td> <select id="type">
			<option value="1"> Normal </option>
			<option value="2"> Caste </option>
			</select></td>
			</tr>		
	</table>	
	<input type="button" value="submit" onclick="getCriticalPanchayatFamilyInfo(0);" class="btn btn-success"/>
...
var jsObj= 
	...
	var url = "<%=request.getContextPath()%>/getCriticalPanchayatConstituenciesAction.action?"+param;
...
function getCriticalPanchayatFamilyInfo(startIndex)
{
...
var jsObj= 
	...
	var param="task="+YAHOO.lang.JSON.stringify(jsObj);
	var url = "<%=request.getContextPath()%>/getcriticalPanchayatFamilyDetailsAction.action?"+param;
	callAjax(param,jsObj,url);
	}
}
	     ...
	     if(jsObj.startIndex==0){
		   $("#paginationDivId").pagination({
			...
			onPageClick: function(pageNumber, event) {
				...
				getCriticalPanchayatFamilyInfo(num);
