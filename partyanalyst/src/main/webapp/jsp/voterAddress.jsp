...
<div id="suggestiveMainDiv" align="center">
 ...
 <table style="width:58%;">
	...
	<input type="button" value="submit" onclick="getVoterInfo(0);" class="btn btn-success"/>
	<div id="showAjaxImg" style="display:none"><img src="./images/icons/search.gif"/></div>
 </div>

  <br/> <br/>
 <div id="voterDetailsDiv" style="overflow-x: scroll; height: 500px;display:none;">
...
function getVoterInfo(startIndex)
{
	var errorDiv =$("#errorDiv");
	$("#VoterDetailsDiv").css("display","none");
...
var jsObj= 
	...
	var param="task="+YAHOO.lang.JSON.stringify(jsObj);
	var url = "<%=request.getContextPath()%>/getVoterAddressAction.action?"+param;
	callAjax(param,jsObj,url);
	}
}
