        	...
        	<div class="panel panel-default">
                ...
                <div class="panel-body bg_EF">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                        	<label>Select Location Type</label><span class="text-danger">*</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 locationsFilterCls mandalCls1">
                        	<label>Mandal/Muncipality</label><span class="text-danger">*</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 locationsFilterCls panchayatCls1">
                        	<label>Panchayat/Ward</label><span class="text-danger">*</span>
