				...
				<div class="row-fluid">
					...
					<input type="hidden" class="form-control border-radius-0 text-align2" value = "${boothId}" name="cadreRegistrationVO.boothId" > 
										...
										<div class="span6">
											...
											<input type="text" class="form-control border-radius-0" placeholder="Voter Telugu Name" style="width:190px;" name="cadreRegistrationVO.voterTeluguName" value="${voterInfoVOList[0].teluguName}"  ></input>											
										</div>	
										<div class="span6">	
