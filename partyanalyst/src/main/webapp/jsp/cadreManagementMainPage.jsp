...
<link rel="stylesheet" type="text/css" href="js/yahoo/yui-js-2.8/build/assets/skins/sam/gallery-accordion.css">
...
<body>
	...
	<div id="cadreSMSGroupsMainDiv">
		...
		<div id="cadreSMSMainDiv">
			<div id="cadreSMSHeadDiv" style="font-size:12px;">Manage Cadre</div>
			<div id="cadreSMSBodyDiv" style="font-size:12px;font-family:verdana;margin-bottom: 15px;">Manage Cadre feature enables the user to add new people into the Cadre, Searching existing Cadres And send SMS to the cadres, based on the location and cadre level.</div>
