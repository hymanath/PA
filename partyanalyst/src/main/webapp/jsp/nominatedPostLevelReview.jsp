						...
						if(result[i].name == "YET TO START" || result[i].name == "RUNNING"){
							<c:choose>
								<c:when test="${fn:contains(sessionScope.USER.entitlements, 'NOMINATED_POST_MOVE_TO_RUNNING_ENTITLEMENT' )}">
									str+='<h3><span class="yetToStartCls" attr_level_id="'+levelId+'" attr_status="'+result[i].name+'" style="cursor:pointer;">'+result[i].totalCorp+'</span><span class="pull-right text-muted">'+result[i].perc+'%</span> </h3>';
								</c:when> 
								<c:otherwise>
							...
							<c:choose>
								<c:when test="${fn:contains(sessionScope.USER.entitlements, 'NOMINATED_POST_MOVE_TO_READY_TO_FINALYZE_ENTITLEMENT' )}">
									str+='<h3><span class="finalReviewCls" attr_level_id="'+levelId+'" attr_status="'+result[i].name+'" style="cursor:pointer;">'+result[i].totalCorp+'</span><span class="pull-right text-muted">'+result[i].perc+'%</span> </h3>';
								</c:when>
								<c:otherwise>
									str+='<h3><span attr_level_id="'+levelId+'" attr_status="'+result[i].name+'">'+result[i].totalCorp+'</span><span class="pull-right text-muted">'+result[i].perc+'%</span> </h3>';
								</c:otherwise>
							...
							<c:choose>
								<c:when test="${fn:contains(sessionScope.USER.entitlements, 'NOMINATED_POST_MOVE_TO_FINALYZE_ENTITLEMENT' )}">
									str+='<h3><span class="finalyzedCls" attr_level_id="'+levelId+'" attr_status="'+result[i].name+'" style="cursor:pointer;">'+result[i].totalCorp+'</span><span class="pull-right text-muted">'+result[i].perc+'%</span> </h3>';
								</c:when>
								<c:otherwise>
									str+='<h3><span attr_level_id="'+levelId+'" attr_status="'+result[i].name+'">'+result[i].totalCorp+'</span><span class="pull-right text-muted">'+result[i].perc+'%</span> </h3>';
								</c:otherwise>
							...
							<c:choose>
								<c:when test="${fn:contains(sessionScope.USER.entitlements, 'NOMINATED_POST_MOVE_TO_G_O_PASSED_ENTITLEMENT' )}">
									str+='<h3><span class="goPassedCls" attr_level_id="'+levelId+'" attr_status="'+result[i].name+'" style="cursor:pointer;">'+result[i].totalCorp+'</span><span class="pull-right text-muted">'+result[i].perc+'%</span> </h3>';
								</c:when>
								<c:otherwise>
									str+='<h3><span attr_level_id="'+levelId+'" attr_status="'+result[i].name+'">'+result[i].totalCorp+'</span><span class="pull-right text-muted">'+result[i].perc+'%</span> </h3>';
								</c:otherwise>
