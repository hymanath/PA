					   ...
					   str+='</div>';
					    ...
					    str+='<div class="col-md-12 m_top20">';
							if(result.atrDetails[i].locationScopeId==1){
								str+='<span id="DistrictShowIdSpan'+result.atrDetails[i].partyMeetingAtrPointId+'">'+result.atrDetails[i].locationName+' District </span>';
							}else if(result.atrDetails[i].locationScopeId==2){
								str+='<span id="ConstShowIdSpan'+result.atrDetails[i].partyMeetingAtrPointId+'">'+result.atrDetails[i].locationName+' Constituency </span>';
							}else if(result.atrDetails[i].locationScopeId==3){
								str+='<span id="ManTwnDivShowIdSpan'+result.atrDetails[i].partyMeetingAtrPointId+'">'+result.atrDetails[i].locationName+'</span>';
							}else if(result.atrDetails[i].locationScopeId==4){
								str+='<span id="VillWardShowIdSpan'+result.atrDetails[i].partyMeetingAtrPointId+'">'+result.atrDetails[i].locationName+'</span>';
							}
					   str+='</div>';
