...
var spinner = '<div class="row"><div class="col-sm-12"><div class="d2d-loader"><div class="loader"></div><img src="ITDP_Assests/images/login_logo.png"/></div></div></div>'
var levelWiseArr='';
	...
	function buildUsersCountsByLocation(result){
		...
		str+='<div class="media">';
			str+='<div class="media-left">';
				str+='<img src="ITDP_Assests/icons/Total_Users_icon.png" class="main_block_logo"></img>';
			str+='</div>';
		...
		/*str+='<div class="row m_top15">';
			str+='<div class="col-sm-6 text-center border_right">';
				str+='<h4>Active Users</h4>';
				if(result.activeUsers !=null && result.activeUsers>0){
					str+='<h3><span><img src="ITDP_Assests/icons/Active_User_icon.png"  class="imageWidthHeigth"/></span>  '+result.activeUsers+'</h3>';
				}else{
					str+='<h3><span><img src="ITDP_Assests/icons/Active_User_icon.png"  class="imageWidthHeigth"/></span>  - </h3>';
				}
			...
			str+='<div class="col-sm-6 text-center">';
				...
				if(result.inActiveUsers !=null && result.inActiveUsers>0){
					str+='<h3><span><img src="ITDP_Assests/icons/Inactive_user_icon.png" class="imageWidthHeigth" /></span>  '+result.inActiveUsers+'</h3>';
				}else{
					str+='<h3><span><img src="ITDP_Assests/icons/Inactive_user_icon.png" class="imageWidthHeigth" /></span>  - </h3>';
				}
...
function getHouseHoldsCounts(){	 
	...
	function buildHouseHoldsCounts(result){
		...
		str+='<div class="media">';
			str+='<div class="media-left">';
				str+='<img src="ITDP_Assests/icons/Total Househols_icon.png" class="main_block_logo" style="height: 71px;"></img>';
			str+='</div>';
			str+='<div class="media-body">';
		...
		str+='<div class="row m_top15">';
			...
			str+='<div class="col-sm-6 text-center border_right m_top10">';
				...
				if(result.visitedHouseHolds !=null && result.visitedHouseHolds>0){
					str+='<h3><span><img src="ITDP_Assests/icons/householder_visited_icon.png" class="imageWidthHeigth" /></span>  '+result.visitedHouseHolds+'</h3>';
				}else{
					str+='<h3><span><img src="ITDP_Assests/icons/householder_visited_icon.png" class="imageWidthHeigth" /></span>  - </h3>';
				}
			...
			str+='<div class="col-sm-6 text-center m_top10">';
				...
				if(result.pendingHouseHolds !=null && result.pendingHouseHolds>0){
					str+='<h3><span><img src="ITDP_Assests/icons/householder_pending_icon.png" class="imageWidthHeigth" /></span>  '+result.pendingHouseHolds+'</h3>';
				}else{
					str+='<h3><span><img src="ITDP_Assests/icons/householder_pending_icon.png" class="imageWidthHeigth" /></span>  - </h3>';
				}
...
function getGrievancesCounts(){	  
	...
	function buildGrievancesCounts(result){
		...
		str+='<div class="media">';
			str+='<div class="media-left">';
				str+='<img src="ITDP_Assests/icons/Total_Grievance_icon.png" class="main_block_logo"></img>';
			str+=' </div>';
			str+='<div class="media-body">';
		...
		str+='<div class="row m_top20">';
			str+='<div class="col-sm-6 text-center border_right">';
				...
				if(result.individual !=null && result.individual>0){
					str+='<h3><span><img src="ITDP_Assests/icons/Individual_icon.png" class="imageWidthHeigth" /></span>  '+result.individual+'</h3>';
				}else{
					str+='<h3><span><img src="ITDP_Assests/icons/Individual_icon.png" class="imageWidthHeigth" /></span>  - </h3>';
				}
			...
			str+='<div class="col-sm-6 text-center">';
				...
				if(result.community !=null && result.community>0){
					str+='<h3><span><img src="ITDP_Assests/icons/Community_icon.png" class="imageWidthHeigth" /></span>  '+result.community+'</h3>';
				}else{
					str+='<h3><span><img src="ITDP_Assests/icons/Community_icon.png" class="imageWidthHeigth" /></span>  - </h3>';
				}
...
function buildDepartmentWiseGrievanceCounts(result,value){
 ...
 function setDefaultImage(img){
	img.src = "ITDP_Assests/images/NoImage.png";
}
