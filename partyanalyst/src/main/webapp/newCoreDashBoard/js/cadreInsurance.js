	...
	function cadreInsuranceClickActions()
	{
		...
		$(document).on("click",".cadreInsuranceCDate li",function(){
			...
			var selectionTypeTS=$("input:radio[name=cadeInsuranceCatTs]:checked").val();
			if(selectionTypeTS == "category"){
		...
		$(document).on("click",".cadeInsuranceCatTs",function(){
			...
			}else if(status == 'categoryStatus')
			{
				...
				getLocationWiseThenStatusWiseInsuranceMemberCountForTS('district','insuredMember','desc',0);
				getLocationWiseThenStatusWiseInsuranceMemberCountForTS('constituency','insuredMember','asc',0);
			}
		});
		/*swadhin*/
