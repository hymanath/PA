...
function buildCommiteeLevel(result,id,levelName){
	...
	str+='<div class="row">';
		if(levelName == "Mandal"){
			...
			str+='<h4 class="text_bold text-capital" >'+levelName+' Level Committee Details</h4>';
		str+='</div>';
	str+='</div>';
	str+='<div class="row">';
		str+='<div class="col-sm-4 m_top10">';
			str+='<div class="pad_d1ab66">';
				str+='<h4 class="">Total Committees</h4>';
				str+='<h3 class="text_bold m_top10">'+result.totalCount+'</h3>';
			str+='</div>';
		str+='</div>';
		str+='<div class="col-sm-4 m_top10">';
			str+='<div class="pad_d1ab66">';
				str+='<h4 class="">Completed Committees</h4>';
				str+='<h3 class="text_bold m_top10">'+result.completedCount+' <small style="color:green;">'+result.completedPerc+' %</small></h3>';
			str+='</div>';
		str+='</div>';
		str+='<div class="col-sm-4 m_top10">';
			str+='<div class="pad_d1ab66">';
				str+='<h4 class="">Not Conducted Committees</h4>';
				str+='<h3 class="text_bold m_top10">'+result.notCompletedCommitteeCount+' <small style="color:green;">'+result.notCompletedCommitteePer+' %</small></h3>';
			str+='</div>';
		str+='</div>';
	str+='</div>';
		str+='<div class="row">';
