...
<div id="menu" class="span6" style="border-top:1px solid #fff;border-bottom:1px solid #fff;padding:5px;margin-bottom:5px;width:660px;margin-left:150px;">
				...
				<!--<c:if test="${fn:contains(sessionScope.USER.entitlements, 'PROBLEM_MANAGEMENT_ENTITLEMENT') }">
					...
					<li><a onmousedown = "return false;" class="parent"><span>Cadre Training</span></a>
						<div>
							<ul>
								...
								<li><a href="trainingCenterDashBoardAction.action"><span>Training Center DashBoard</span></a></li>
					...
					<li><a onmousedown="return false;" class="parent"><span>IVR Campaigns</span></a>
						<div>
							<ul>
								<c:if test="${sessionScope.USER.isAdmin == 'true'}">						
									<li><a href="cadreIvrReportAction.action"><span> Cadre IVR Dashboard</span></a></li>
									<li><a href="villageIVRAction.action"><span> Committee IVR Dashboard </span></a></li>
					...
					<li><a href="activitiesDashboard.action"><span> Activities DashBoard  </span></a></li>
