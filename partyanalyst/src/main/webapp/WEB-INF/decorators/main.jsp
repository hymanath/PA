	...
	<c:if test="${sessionScope.loginStatus == 'out' && sessionScope.hasPartyAnalystUserRole == true}"> 	
	    ...
	    { 
	        ...
	        itemdata: [  
				...
				{ text: "Live Results Analysis", 
					 submenu : {
				     id  : "Live_Results_Analysis",
					 itemdata : [
						{text: "Live & Previous Results Comparison", url: "electionLiveResultsAnalysisAction.action"},
						{text: "Ministers & Special Candidates Analysis", url: "ministerAnalysisAction.action"},
						{text: "Update Live Election Results", url: "electionResultsUpdateAction.action"},
						{text: "Assign Special Candidates", url: "assignKeyCandidateAction.action"}
	    ...
	    { 
	        ...
	        itemdata: [ 
						...
						{ text: "Manipur", url: "statePageAction.action?stateId=16"},
						{ text: "Goa", url: "statePageAction.action?stateId=6"},
						{ text: "Meghalaya", url: "statePageAction.action?stateId=17"},
						{ text: "Nagaland", url: "statePageAction.action?stateId=19"},
						{ text: "Tripura", url: "statePageAction.action?stateId=25"}
	        ]     
	    }, 
	    { 
	        id: "search", 
			...
			width: 200px;"></select></td></tr></table>
							...
							<div class="widgetsFooter" style="background-color:#FFFFFF;height:37px;">
								<table width="90%"><tr>
									...
									<td width="35%"><img style="cursor:pointer" width="70" height="25" src="images/icons/homePage_new/b3.jpg" onclick="viewElectionResults()"></img></td>
								</tr></table>
							</div>
						</div>
