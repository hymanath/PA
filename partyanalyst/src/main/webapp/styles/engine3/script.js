...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container3").wowSlider({effect:"basic_linear",prev:"prev",next:"next",duration:20*100,delay:30*100,width:320,height:240,autoPlay:true,stopOnHover:true,loop:true,bullets:0,caption:true,captionEffect:"slide",controls:true,logo:"engine3/loading.gif",onBeforeStep:0,images:0});