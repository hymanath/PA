				...
				f = {
					...
					_upload: function(i) {// 111
						...
						if(n.uploadFile.data != null && $.isPlainObject(n.uploadFile.data)) {
							...
							n.uploadFile.data = {"activityScopeId":gobalActivityScopeId,"day":gobalDay,
													"levelId":gobalLevelId,levelValue:gobalLevelValue,
													"activityDate":gobalActivityDate,gobalTempVar:gobalTempVar,insertType:"WEB","eventDateStr":gobalDateStr,"tableName":globalTableName,"activityLocationInfoId":globalLctnInfoId}
									...
									if(flag)//setting levelId and levelValue
									{
									   if(levelIds == 2)
										...
										{//division pending
										   ...
										   if(firstChar == 2)
										   {
											  gobalLevelId = 5;gobalLevelValue = locationValue;
										   }
										   else if(firstChar == 1)
										   {
											  gobalLevelId = 7;gobalLevelValue = locationValue; 
										   }
										}
										...
										{//division pending
										   ...
										   if(firstChar == 1)
										   {
											  gobalLevelId = 6;gobalLevelValue = locationValue;
										   }
										   else 
										   {
											  gobalLevelId = 8;gobalLevelValue = locationValue; 
										   }
										}
										gobalActivityScopeId = activityName;
									}
								}*/
								     //console.log(gobalActivityScopeId)
									//console.log(gobalLevelId)
									//console.log(gobalLevelValue)
									
													
									return n.uploadFile.beforeSend != null && typeof n.uploadFile.beforeSend == "function" ? n.uploadFile.beforeSend(el, l, p, o, s, c.id, jqXHR, settings) : true;
								},
								success: function(data, textStatus, jqXHR) {
									el.find(".icon-jfi-trash").addClass("deleteFile").attr('id', ''+data.resultState+'');
									c.uploaded = true;
