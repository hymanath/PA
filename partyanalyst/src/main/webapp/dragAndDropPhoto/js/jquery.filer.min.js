				...
				f = {
					...
					_upload: function(i) {// 111
						...
						if(n.uploadFile.data != null && $.isPlainObject(n.uploadFile.data)) {
							...
							n.uploadFile.data = {"activityScopeId":$("#ActivityList").val(),"day":$("#day").val(),
							 "levelId":$("#levelIds option:selected" ).val(),"stateId":$("#statesDivId").val(),
							...
							//console.log("222:  "+n.uploadFile.data);
