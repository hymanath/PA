...
$(document).on("click",".getImageCls",function(){
	...
	var attr_activity_scopeid = $('#ActivityList').val();
...
function buildDayWisImagesForPopup1(result,jObj,path,attr_activity_scopeid,locationScope,locationScopeValue)
{
	...
	if(result != null)
	{
	   ...
	   if(jObj.startIndex==0){
		   $("#paginationImagesDivId").html('');
		   $("#paginationImagesDivId").pagination({
				items: itemsCount,
			...
			$("#paginationImagesDivId").find("ul").addClass("pagination");
		}
...
$(document).on("click","#paginationImagesDivId ul li",function(){
	$("#paginationImagesDivId").find("ul").addClass("pagination");
});
	...
	var str='';
		str+='<div class="row">';
			str+='<div class="col-md-9">';
				...
				str+='</div>';
				str+=' <div id="paginationDivId1"></div>';
			str+='</div>';
			str+='<div class="col-md-3" style="box-shadow:0 2px 10px 0 rgba(0, 0, 0, 0.35);padding:0px">';
			if(searchType == "constituency")
