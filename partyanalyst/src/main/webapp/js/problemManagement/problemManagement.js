...
{	
	...
	for(var i=0;i<newProblems.length; i++)
	{
		...
		bStr += '<a class="problem_title" target="_blank" href="completeProblemDetailsAction.action?problemId='+newProblems[i].problemHistoryId+'" >'+newProblems[i].problem+'</a></div></td>';
