...
function buildProblemViewingWindow()
{
	...
	else
	{
		...
		onclick="getProblemCompleteDetails('+data.problemHistoryId+')"
			...
			str+='			<span><img height="10" width="10" src="images/icons/constituencyPage/bullet_blue.png"></img></span>';
			str+='			<span>';
			str+='				<a class="districtAnc" style="font-size:14px;font-family:Verdana;text-transform: capitalize;color:#222;" href="completeProblemDetailsAction.action?problemId='+data.problemHistoryId+'">'+data.problem+'</a></span>';
			str+='		</td>';
