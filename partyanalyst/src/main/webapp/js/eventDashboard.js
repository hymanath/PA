...
function setcolorsForEvents()
	{
		...
		var colorStatic = new Array('#FFEE1A','#7FE6E5','#00B17D','#D64D54','#5C2D25','#7AA300','#7A7ACC','#5CB8E6','#2E5C00','#194775','#73008C','#1F8F99','#7A637A','#A6A88A','#996633','#2E0F2E','#5C5C8A','#1F7A7A','#944DDB','#738ACF','#120B0B','#800B0B','#1FCB9D','#90446A','#A9F5A9','#F8E0F7','#CECEF6','#A9F5D0','#8000FF','#E3F6CE','#CEE3F6','#E0F8E0','#5E610B');
