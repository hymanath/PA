$(document).ready(function(){
	...
	/*if( $('.mini-pie-chart').length > 0 ) {
		var visitData = [[30, 15, 55], [65, 25, 10], [55, 15, 30], [25, 25, 50], [40, 35, 25], [70, 15, 15], [15, 25, 60], [40, 35, 25], [70, 15, 15], [15, 25, 60]];
		var params = {
			type: "pie",
...
/*
var data = [
			{ label: "Printed Cards",  data: 65},
			{ label: "Pending Cards",  data: 20},
			{ label: "Error Cards", data: 15}
		];
...
*/
	...
	function donutLabelFormatter(label, series) {
		return "<div class=\"donut-label\">" + label + " (" + Math.round(series.percent) + "%) </div>";
	}
