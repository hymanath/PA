...
public interface ILocationDetailsService {
	...
	public List<KeyValueVO> getMandalsBySearchTypeAndConstituencyId(String serchType,List<Long> conIds,List<Long> deptIds,String fromDate,String toDate,List<Long> desigids,String desigType, List<Long> statIds,Long userId,List<Long> subjectIds,List<Long> leadIdsLst);
