...
public interface IConstants {
 ...
 // public static final String STATIC_CONTENT_FOLDER_URL = "/app/static_content/PRRWS/";
    ...
    public static final List<Long> PETITION_NEXT_BUDGET_BRIEF_LEAD_IDS=Arrays.asList(24l,36l);
    public static final List<Long> PETITIONS_CENTRAL_BUDGET_BRIEF_LEAD_IDS=Arrays.asList(10l,33l);
