...
public interface ILightWattageDAO  extends GenericDao<LightWattage, Long > {
	...
	public List<Object[]> getTotalWattege(Date fromDate,Date toDate,String locationType,List<Long> locationValues,List<Long> lightMonitoringIds,String isLightVendorGroupRequired);
