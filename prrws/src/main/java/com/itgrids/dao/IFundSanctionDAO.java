...
public interface IFundSanctionDAO extends GenericDao<FundSanction,Long>{
	...
	public List<Object[]> getFundSanstionLocationWise(List<Long> financialYearIdsList, List<Long> departmentId, Date startDate, Date endDate, Long superLocationId, String type);
}
