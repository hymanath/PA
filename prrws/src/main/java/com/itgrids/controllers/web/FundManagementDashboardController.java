...
public class FundManagementDashboardController {
	...
	@RequestMapping(value = "/getTotalSchemes", method = RequestMethod.POST,
		...
		public @ResponseBody LocationVO getFundManagementSystemWorkDetails(@RequestBody InputVO inputVO){
			LocationVO loctions = constituencyWiseWorkStatusService.getFundManagementSystemWorkDetails(inputVO.getFinancialYrIdList(),inputVO.getDeptIdsList(),inputVO.getFromDateStr(),inputVO.getToDateStr(),inputVO.getLocationId());
			return loctions;
		}
