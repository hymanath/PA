...
public class LabourBudgetOverViewVO implements Serializable{

	private String totalBudget;
	private String totalExpenditure;
	private String avgWagePerPerson;
	private String budgetForLabour;
	...
	public String getAvgWagePerPerson() {
		return avgWagePerPerson;
	}
	public void setAvgWagePerPerson(String avgWagePerPerson) {
		this.avgWagePerPerson = avgWagePerPerson;
	}
	public String getBudgetForLabour() {
		return budgetForLabour;
	}
	public void setBudgetForLabour(String budgetForLabour) {
		this.budgetForLabour = budgetForLabour;
	}
	public String getBudgetForMaterial() {
		return budgetForMaterial;
	}
	public void setBudgetForMaterial(String budgetForMaterial) {
		this.budgetForMaterial = budgetForMaterial;
	}
