...
<title>MGNREGS Login Page</title>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-1 col-xs-3 pad_left0">
				<img src="Assests/img/aplogo.png" class="logo" alt="logo">
			</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="text-center">
					<img src="Assests/images/NREGS-LOGO.png">
				</div>
				<div class="text-center text-capital">
					<h2 style="color:white;" class="m_top10">Mahatma Gandhi National Rural Employement Guarantee Scheme</h2>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3 text-center">
				...
				<p style="font-size: 12px;">Minister for Information Technology,<br/> Panchayat Raj and Rural Development,<br/>(Government of Andhra Pradesh)</p>
			</div>
		</div>
	</div>
</section>
