...
<title>Key performance dashboard</title>
...
<section>
		<div class="container-fluid m_top20">
		  <div class="white-block">
			<h3 style="margin-bottom:12px;">KPI - STATELEVEL OVERVIEW</h3>
			<div class="row">
...
<script src="Assests/ruralWaterSupply/keyPerformanceDashBoard.js" type="text/javascript"></script>
</body>
</html>