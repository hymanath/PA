...
$(document).on("click",".cloned_Element",function(){
	...
	*/
	...
	$(".appendWorkDetailsDiv"+typeVal+"").append(clondTemplate(blockId,'clone',counterId,typeVal,counterappendId,"No"));
...
function clondTemplate(blockId,type,counterId,typeVal,counterappendId,isNew){
	...
	if(isNew =="Yes")
		...
		clonedTemplate+='<div class="pull-right removeWorkCls" id="manageInnerWorks'+globalWorkTypeCount+'" attr_inner_works_Count="1" attr_id="mainWorkDivId'+counterappendId+''+blockId+'" attr_type="'+typeVal+'" attr_candidateid="1"><i class="glyphicon glyphicon-remove"></i></div>';
				...
				clonedTemplate+='<div class="row m_top10 " id="workDivId'+counterappendId+''+blockId+'" >';
							...
							clonedTemplate+='<div class="row m_top10">';
									clonedTemplate+='<div class="col-sm-3">';
										...
										clonedTemplate+='<select  name="worksList['+counterappendId+'].subWorksList['+defaultValue+'].locationScopeId" class="form-control chosen-select m_top10 locationLevelChange locationLevelValidCls'+typeVal+' validateCls" id="locationLevelId'+typeVal+''+counterappendId+''+blockId+'" attr_counterval="'+counterappendId+''+blockId+'" attr_type="'+typeVal+'" attr_type_change="main" attr_main_count="'+counterappendId+'" attr_inner_count="'+blockId+'">';
											...
											clonedTemplate+='<option value="5">Mandal/Munci./Corp</option>';
					...
					clonedTemplate+='<div class="col-sm-12">';
						clonedTemplate+='<div class="pull-right">';
							clonedTemplate+='<span class="addLocationCss m_top10 pull-right cloned_Inner_Element" style="cursor:pointer;" attr_type="'+typeVal+'" attr_counterval="'+counterappendId+'" main_work_count="'+globalWorkTypeCount+'" inner_work_count="1" attr_id="manageInnerWorks'+globalWorkTypeCount+'">ADD WORK  </span>';
						clonedTemplate+='</div>';
					clonedTemplate+='</div>';					
				clonedTemplate+='</div>';					
		clonedTemplate+='</div>';
...
$(document).on("click",".cloned_Inner_Element",function(){
	...
	*/
	...
	$('#'+mangageWorksId+'').attr("attr_inner_works_Count",parseInt(attr_inner_works_Count)+1);
		...
		$(".appendInnerBlocks"+typeVal+counterId+innerWorkCount).append(clonedInnerTemplate('clone',counterId,typeVal,mainWorkCount,innerWorkCount,conterInnerVal,mangageWorksId));
		$(".chosen-select").chosen({width:'100%'});
...
function clonedInnerTemplate(type,counterId,typeVal,mainWorkCount,innerWorkCount,conterInnerVal,parentRemoveClsId){ 
	...
	clonedInnerTemplate+='<div class="m_top10" style="padding: 15px;">';
		...
		clonedInnerTemplate+='<div class="pull-right  removeInnerWorkCls" id="'+parentRemoveClsId+'" attr_id="workDivId'+counterId+''+innerWorkCount+'" attr_type="self" attr_candidateid="1"><i class="glyphicon glyphicon-remove"></i></div>';
				...
				clonedInnerTemplate+='<div class="row m_top10">';
						clonedInnerTemplate+='<div class="col-sm-3">';
							...
							clonedInnerTemplate+='<select  name="worksList['+counterId+'].subWorksList['+innerWorkCount+'].locationScopeId" class="form-control chosen-select m_top10 locationLevelChange locationLevelValidCls'+typeVal+' validateCls" id="locationLevelInnerId'+typeVal+''+counterId+''+innerWorkCount+'" attr_counterval="'+counterId+''+innerWorkCount+'" attr_type="'+typeVal+'" attr_type_change="Inner" attr_main_count="'+counterId+'" attr_inner_count="'+innerWorkCount+'">';
								...
								clonedInnerTemplate+='<option value="5">Mandal/Munci/Corp</option>';
...
function buildPetitionDetails(result){
				...
				refCandCount=refCandCount+1;
					...
					str+='<div id="candidatesAppendDiv'+result.referDetailsList[i].refCandidateId+'" style="position:relative;">';
						...
						if(result.referDetailsList[i].fileNamesList !=null && result.referDetailsList[i].fileNamesList.length>0){
							...
							if(result.representationType == "REPRESENTEE" || result.representationType == "REPRESENT"){
								str+='<div class="pull-right showRemoveIcon" attr_type='+result.representationType+' attr_candidate_id="'+result.referDetailsList[i].refCandidateId+'"><i class="glyphicon glyphicon-remove"></i></div>';
							}
									...
									for(var j in result.referDetailsList[i].fileNamesList){
										...
										if( scanCopyExt =="jpeg" || scanCopyExt =="jpg"  || scanCopyExt =="gif"  || scanCopyExt =="bmp"  || scanCopyExt =="png" || scanCopyExt =="pdf"){
												str+='<div class="col-sm-2" id="refDocument'+i+''+j+'">';
													...
													str+='<div class="pull-right removeFileCls" attr_id="refDocument'+i+''+j+'" style="margin-right: 15px;cursor:pointer"><i class="glyphicon glyphicon-remove"></i></div>';
													if(scanCopyExt =="pdf"){
						...
						for(var i in result.fileList){
							...
							var scanCopyExt = $.trim(scanCopySpl[scanCopySpl.length-1].toLowerCase()); 
								...
								if( scanCopyExt =="jpeg" || scanCopyExt =="jpg"  || scanCopyExt =="gif"  || scanCopyExt =="bmp"  || scanCopyExt =="png" || scanCopyExt =="pdf"){
									...
									str+='<div class="pull-right removeFileCls" attr_id="workDocument'+i+'" style="margin-right: 15px;cursor:pointer"><i class="glyphicon glyphicon-remove"></i></div>';
									if(scanCopyExt =="pdf"){
	...
	var innerWorkTypeCount=0;
		for(var i in result.subWorksList){
				...
				str+='<div class="col-sm-12 m_top20 mainWorkDivCls " id="mainWorkDivId'+i+''+globalWorkTypeCount+'">';
				if(i !=0){
					str+='<div class="pull-right removeWorkCls"  id="manageInnerWorks'+globalWorkTypeCount+'" attr_inner_works_Count="'+result.subWorksList[i].subWorksList.length+'"  attr_id="mainWorkDivId'+i+''+globalWorkTypeCount+'" attr_type="self'+result.representationType+'">';
					str+='<i class="glyphicon glyphicon-remove"></i>';
				}else{
					str+='<div class="pull-right "  id="manageInnerWorks'+globalWorkTypeCount+'" attr_inner_works_Count="'+result.subWorksList[i].subWorksList.length+'"  attr_id="mainWorkDivId'+i+''+globalWorkTypeCount+'" attr_type="self'+result.representationType+'">';
				}
					str+='</div>';
						...
						str+='<div>';
							...
							str+='<div class="row m_top10" >';
								str+='<div class="col-sm-3">';
										...
										str+='</select><br><span class="WorkTypeWiseDepartmentId'+result.representationType+''+i+''+globalWorkTypeCount+'"></span>';
									str+='</div>';
								...
								str+='<div class="col-sm-3">';
									...
									str+='</select><br><span class="subjectId'+result.representationType+''+i+''+globalWorkTypeCount+'"></span>';
								str+='</div>';
							...
							for(var j in result.subWorksList[i].subWorksList){
								...
								str+='<div class="m_top10" id="workDivId'+i+''+j+'">';
										str+='<div class="col-sm-12">';
										if(j !=0){
												str+='<div class="pull-right removeInnerWorkCls" id="manageInnerWorks'+globalWorkTypeCount+'" attr_id="workDivId'+i+''+j+'" attr_type="self" attr_candidateid="1">';
												str+='<i class="glyphicon glyphicon-remove"></i>';
											}else{
											...
											str+='<div class="bg_color_view">';
												...
												str+='<div class="row m_top10">';
														str+='<div class="col-sm-3">';
															...
															str+='</select> <br><span class="locationLevelId'+result.representationType+''+i+''+j+'"></span>';
														str+='</div>';
														...
														if(result.subWorksList[i].subWorksList[j].locationScopeId == 3){
																...
																str+='<option value="0" > Select District </option>';
																	...
																	str+='</select><br><span class="districtId'+result.representationType+''+i+''+j+'"></span>';
																str+='</div>';
																...
																str+='</select><br><span class="constituencyId'+result.representationType+''+i+''+j+'"></span>';
															str+='</div>';
															...
															str+='<div class="col-sm-2 mandalCls'+result.representationType+''+i+''+j+'" style="display:none;">';
																...
																str+='</select><br><span class="mandalId'+result.representationType+''+i+''+j+'"></span>';
															str+='</div>';
															...
															str+='<div class="col-sm-2 panchayatCls'+result.representationType+''+i+''+j+'" style="display:none;">';
																...
																str+='</select><br><span class="panchayatId'+result.representationType+''+i+''+j+'"></span>';
															str+='</div>';
														}else if (result.subWorksList[i].subWorksList[j].locationScopeId == 4){
															str+='<div class="col-sm-2 districtCls'+result.representationType+''+i+''+j+'" >';
																str+='<label>DISTRICT <span class="starColor">*</span></label>';
