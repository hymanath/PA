...
function getLocationWiseWorksInformation(){
	...
	$.ajax({                
		...
		if(result != null && result.length > 0){
			$(".EncWorksAllCls").html(''+result[0].notGrounded+' /'+result[0].underProcessCount+'');
		}else{
