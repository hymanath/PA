...
function getWorkCompletionData(){
	$(".CompletionOfWorksAllCls").html(spinner); 
	var json = {
		year : "2017",
		fromDate : "2017-04-01",
		toDate : glEndDate,
	...
	$.ajax({                
		...
		if(result !=null && result.length > 0){
			...
			$(".CompletionOfWorksAllCls").html(total+' / '+finacialYearCount); 
		}else{
			$(".CompletionOfWorksAllCls").html("0 / 0"); 
		}
	});
}