		...
		for (var i in result) {
			...
			str +='<div class="col-sm-4 draggable-element" order-by="'+result[i].id+'">'
				str +='<div class="whiteBlock">';
					if(compnentName == "WATER TANK CLORINATION"){
						str +='<img src="Assests/img/'+imagesObj[compnentName]+'" style="width: 52px; height: 50px;">';
					}else{
