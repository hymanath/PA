					...
					str+='<div class="row">';
						str+='<div class="col-sm-12 m_top10">';
							str+='<div class="custom-div-bg" style="padding-top: 8px;padding-bottom: 10px;">';
								str+='<h4 class="font_weight" style="font-size: 15px;"><i class="fa fa-check-circle-o green_color fa-2x" style="position: relative;top: 4px;"></i> <span style="margin-left: 20px;">Conducted</span> <span style="margin-left: 30px;">'+result.conductedMeetings+'</span></h4>';
							str+='</div>';
						str+='</div>';
					str+='</div>';
				str+='</div>';
