					...
					str+='<div class="col-sm-4">';
						str+='<div class="block-border">';
							...
							str+='<div class="row">';	
								for(var i in result)
								{
									if(result[i] == "OPGK-Perinnials" || result[i] == "OPGK-Annuals" || result[i] == "Animal Husbandry Others"){
