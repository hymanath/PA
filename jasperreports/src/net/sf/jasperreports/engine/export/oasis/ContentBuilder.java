...
public class ContentBuilder
{
	...
	public void build() throws IOException
	{
		...
		//added by mahesh
		writer.write(" xmlns:rpt=\"http://openoffice.org/2005/report\" ");
		writer.write(" xmlns:of=\"urn:oasis:names:tc:opendocument:xmlns:of:1.2\" "); 
		writer.write(" xmlns:xhtml=\"http://www.w3.org/1999/xhtml\" ");
		writer.write(" xmlns:grddl=\"http://www.w3.org/2003/g/data-view#\" "); 
		writer.write(" xmlns:tableooo=\"http://openoffice.org/2009/table\" "); 
		writer.write(" xmlns:textooo=\"http://openoffice.org/2013/office\" "); 
		writer.write(" xmlns:field=\"urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0\">");
		//added by mahesh end
		...
		if (fontFaces != null)
		{
			for (Iterator it = fontFaces.iterator(); it.hasNext();)
			{
				...
				//changed by mahesh
				if(fontFace != null && fontFace.equalsIgnoreCase("Gautami")){
					writer.write(" svg:font-family=\"" + fontFace + "\"  style:font-pitch=\"variable\" ");
				    writer.write("/>\n");
				}else{
